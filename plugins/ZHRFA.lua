...
if database:get(bot_id.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "*💥¦* تم الغاء امر الزخرفه ✔")
database:del(bot_id.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
...
if chat_type == 'super' then 
if MSG_TEXT[1] == 'تفعيل الزخرفه' and Mod(msg) then   
if database:get(bot_id..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الزخرفه *\n✓' 
send( msg.chat_id_, msg.id_,' taha) 
database:del(bot_id..'lock:skrfa'..msg.chat_id_) 
else
...
if MSG_TEXT[1] == 'تعطيل الزخرفه' and Mod(msg) then   
if not database:get(bot_id..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الزخرفه *\n✓' 
send( msg.chat_id_, msg.id_,'taha) 
database:set(bot_id..'lock:skrfa'..msg.chat_id_,true) 
else
