...
JSON   = (loadfile "./Offices/json.lua")()
redis  = (loadfile "./Offices/redis.lua")()
URL    = (loadfile "./Offices/url.lua")()
...
if not redis:get(DEVGLOBLA..":token") then
io.write('\27[1;35m\n Send ( Token )Bot ↓ :\n\27[0;33;49m')
local token = io.read()
if token ~= '' then
...
redis:set(DEVGLOBLA..":token",token)
end 
else
...
config = {
token = redis:get(DEVGLOBLA..":token"),
SUDO = redis:get(DEVGLOBLA..":SUDO:ID"),
 }
...
f:close()  
redis:del(DEVGLOBLA..":token")
redis:del(DEVGLOBLA..":SUDO:ID")
end  
...
local hash = redis:sismember('Globla:'..bot_id..'Sudo_bot:User', msg.sender_user_id_) 
...
local hash = redis:sismember('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, msg.sender_user_id_) 
...
local hash = redis:sismember('Globla:'..bot_id..'Constructor'..msg.chat_id_, msg.sender_user_id_) 
...
function Owners(msg)
local hash = redis:sismember('Globla:'..bot_id..'Owners'..msg.chat_id_,msg.sender_user_id_)    
...
function Mod(msg)
local hash = redis:sismember('Globla:'..bot_id..'Mod:User'..msg.chat_id_,msg.sender_user_id_)    
...
local hash = redis:sismember('Globla:'..bot_id..'Special:User'..msg.chat_id_,msg.sender_user_id_) 
...
dev = true  
elseif redis:sismember('Globla:'..bot_id..'Sudo_bot:User', user_id) then
dev = true  
...
dev = true  
elseif redis:sismember('Globla:'..bot_id..'Owners'..chat_id, user_id) then
dev = true  
...
dev = 'البوت'
elseif redis:sismember('Globla:'..bot_id..'Sudo_bot:User', user_id) then
dev = redis:get('Globla:'..bot_id.."Sudo_bot:Rd"..msg.chat_id_) or 'المطور'  
elseif redis:sismember('Globla:'..bot_id..'Basic:Constructor'..chat_id, user_id) then
dev = redis:get('Globla:'..bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي'
elseif redis:sismember('Globla:'..bot_id..'Constructor'..chat_id, user_id) then
dev = redis:get('Globla:'..bot_id.."Constructor:Rd"..msg.chat_id_) or 'المنشئ'  
elseif redis:sismember('Globla:'..bot_id..'Owners'..chat_id, user_id) then
dev = redis:get('Globla:'..bot_id.."Owners:Rd"..msg.chat_id_) or 'المدير'  
elseif redis:sismember('Globla:'..bot_id..'Mod:User'..chat_id, user_id) then
dev = redis:get('Globla:'..bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن'  
elseif redis:sismember('Globla:'..bot_id..'Special:User'..chat_id, user_id) then  
dev = redis:get('Globla:'..bot_id.."Special:Rd"..msg.chat_id_) or 'المميز'  
else  
dev = redis:get('Globla:'..bot_id.."Memp:Rd"..msg.chat_id_) or 'العضو'
end  
return dev
end 
...
MDER = redis:smembers('Globla:'..bot_id..'Owners'..v)
...
redis:sadd('Globla:'..bot_id..'Owners'..idg,idmder)  
end
end
if v.MOD then
...
redis:sadd('Globla:'..bot_id..'Muted:User'..msg.chat_id_,msg.sendMsger_user_id_) 
msgm = msg.id_
my_ide = msg.sendMsger_user_id_
local num = 100
for i=1,tonumber(num) do
...
redis:incr('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sendMsger_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
redis:sadd('Globla:'..bot_id..'User_Bot',msg.sendMsger_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
if not redis:get('Globla:'..bot_id..'Start:Time'..msg.sendMsger_user_id_) then
...
redis:setex('Globla:'..bot_id..'Start:Time'..msg.sendMsger_user_id_,300,true)
return false
end
if not Sudo_id(msg) and not redis:sismember('Globla:'..bot_id..'Ban:User_Bot',msg.sendMsger_user_id_) and not redis:get('Globla:'..bot_id..'Tuasl:Bots') then
...
redis:sadd('Globla:'..bot_id..'Ban:User_Bot',data.id_)  
return false  
end 
...
local Text = '🗣┋ المستخدم » '..Name..'\n🚫┋ تم حظرهہ‌‏ من التواصل '
sendMsgText(SUDO,Text,msg.id_/2097152/0.5,'md')
redis:srem('Globla:'..bot_id..'Ban:User_Bot',data.id_)  
return false  
end 
...
if redis:get('Globla:'..bot_id..'Tuasl:Bots') then
redis:del('Globla:'..bot_id..'Tuasl:Bots') 
Text = '\n☑┋ تم تفعيل التواصل ' 
else
...
if not redis:get('Globla:'..bot_id..'Tuasl:Bots') then
redis:set('Globla:'..bot_id..'Tuasl:Bots',true) 
Text = '\n🚫┋ تم تعطيل التواصل' 
else
...
if redis:get('Globla:'..bot_id..'Free:Bots') then
redis:del('Globla:'..bot_id..'Free:Bots') 
...
if not redis:get('Globla:'..bot_id..'Free:Bots') then
redis:set('Globla:'..bot_id..'Free:Bots',true) 
...
redis:setex('Globla:'..bot_id..'Set:Name:Bot'..msg.sendMsger_user_id_,300,true) 
...
local Users = redis:scard('Globla:'..bot_id..'User_Bot')  
Text = '📈┋ الاحصائيات : \n'..'👥┋ عدد المجموعات المفعلهہ‌‏ : {'..Groups..'}'..'\n👤┋ عدد المشتركين في البوت : {'..Users..'}'
sendMsg(msg.chat_id_, msg.id_,Text) 
return false
end
if text == ("المطورين 🕹") and Sudo_id(msg) then
local list = redis:smembers('Globla:'..bot_id..'Sudo_bot:User')
t = "\n📃┋ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
redis:setex('Globla:'..bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_, 600, true) 
...
redis:setex('Globla:'..bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_, 600, true) 
sendMsg(msg.chat_id_, msg.id_,"📥┋ ارسل لي سواء >> { ملصق, متحركهہ‌‏, صوره, رسالهہ‌‏ }\n☑┋ للخروج ارسل الغاء ") 
return false
end  
if text=="اذاعه بالتوجيه 🔖" and msg.reply_to_message_id_ == 0  and Sudo_id(msg) then 
redis:setex('Globla:'..bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_, 600, true) 
...
redis:setex('Globla:'..bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_, 600, true) 
sendMsg(msg.chat_id_, msg.id_,"📥┋ ارسل لي التوجيه الان") 
return false
end 
...
local pv = redis:smembers('Globla:'..bot_id.."User_Bot")
local sendMsgok = 0
for i = 1, #pv do
...
redis:srem('Globla:'..bot_id.."User_Bot",pv[i])
...
redis:setex('Globla:'..bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 360, true)  
...
redis:sadd('Globla:'..bot_id..'Sudo_bot:User', result.id_)
...
redis:sadd('Globla:'..bot_id..'Sudo_bot:User', userid)
...
function start_function(extra, result, success)
if result.id_ then
redis:srem('Globla:'..bot_id..'Sudo_bot:User', result.id_)
usertext = '\n👤┋المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
...
redis:srem('Globla:'..bot_id..'Sudo_bot:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم تنزيلهہ‌‏ من المطورين'
...
--------------------------------------------------------------------------------------------------------------
if redis:get('Globla:'..bot_id..'Set:Name:Bot'..msg.sendMsger_user_id_) then 
if text == 'الغاء' or text == 'الغاء ✖' then   
sendMsg(msg.chat_id_, msg.id_,"☑┋ تم الغاء حفظ اسم البوت") 
redis:del('Globla:'..bot_id..'Set:Name:Bot'..msg.sendMsger_user_id_) 
return false  
end 
redis:del('Globla:'..bot_id..'Set:Name:Bot'..msg.sendMsger_user_id_) 
...
if redis:get('Globla:'..bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) then 
if text == 'الغاء' or text == 'الغاء ✖' then   
sendMsg(msg.chat_id_, msg.id_,"☑┋ تم الغاء الاذاعه للخاص") 
redis:del('Globla:'..bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) 
return false
end 
local list = redis:smembers('Globla:'..bot_id..'User_Bot') 
...
if redis:get('Globla:'..bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) then 
if text == 'الغاء' or text == 'الغاء ✖' then   
sendMsg(msg.chat_id_, msg.id_,"☑┋ تم الغاء الاذاعه") 
redis:del('Globla:'..bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) 
return false
end 
local list = redis:smembers('Globla:'..bot_id..'Chek:Groups') 
if msg.content_.text_ then
...
if redis:get('Globla:'..bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) then 
if text == 'الغاء' or text == 'الغاء ✖' then   
sendMsg(msg.chat_id_, msg.id_,"☑┋ تم الغاء الاذاعه") 
redis:del('Globla:'..bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) 
return false  
end 
...
if redis:get('Globla:'..bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) then 
if text == 'الغاء' or text == 'الغاء ✖' then   
sendMsg(msg.chat_id_, msg.id_,"☑┋ تم الغاء الاذاعه") 
redis:del('Globla:'..bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers('Globla:'..bot_id..'User_Bot')   
...
if redis:get('Globla:'..bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then 
if text and text:match("^الغاء$") then 
sendMsg(msg.chat_id_, msg.id_, "✖┋ تم الغاء الامر ") 
redis:del('Globla:'..bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
return false  end 
redis:del('Globla:'..bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
...
if redis:get('Globla:'..bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then 
if text and text:match("^الغاء$") then 
sendMsg(msg.chat_id_, msg.id_, "✖┋ تم الغاء الامر ") 
redis:del('Globla:'..bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
return false  end 
redis:del('Globla:'..bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
...
if redis:get('Globla:'..bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sendMsger_user_id_) then 
...
redis:del('Globla:'..bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sendMsger_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if redis:get('Globla:'..bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then  
if text == 'الغاء' then 
sendMsg(msg.chat_id_, msg.id_,"✖┋ تم الغاء وضع الوصف") 
redis:del('Globla:'..bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)
return false  
end 
redis:del('Globla:'..bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if redis:get('Globla:'..bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then 
if text == 'الغاء' then 
sendMsg(msg.chat_id_, msg.id_,"✖┋ تم الغاء حفظ الترحيب") 
redis:del('Globla:'..bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
return false  
end 
redis:del('Globla:'..bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
...
--------------------------------------------------------------------------------------------------------------
if redis:get('Globla:'..bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sendMsger_user_id_) then
if text == 'الغاء' then
sendMsg(msg.chat_id_,msg.id_,"📥┋ تم الغاء حفظ الرابط")       
redis:del('Globla:'..bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sendMsger_user_id_) 
return false
end
...
local post_count = tonumber(redis:get('Globla:'..bot_id..'floodc:'..msg.sendMsger_user_id_..':'..msg.chat_id_) or 0)
...
redis:setex('Globla:'..bot_id..'floodc:'..msg.sendMsger_user_id_..':'..msg.chat_id_, tonumber(redis:hget('Globla:'..bot_id.."flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
...
--------------------------------------------------------------------------------------------------------------
if text and redis:get('Globla:'..bot_id..'lock:Fshar'..msg.chat_id_) and not Owners(msg) then 
...
------------------------------------------------------------
if text and redis:get('Globla:'..bot_id..'lock:Iran'..msg.chat_id_) and not Owners(msg) then 
...
redis:incr('Globla:'..bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sendMsger_user_id_) 
end
...
sendMsg(msg.chat_id_, msg.id_,'⚠️┋ عدد اعضاء المجموعهہ‌‏ قليلهہ‌‏ يرجى جمع >> {'..(redis:get('Globla:'..bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
...
if text == 'تفعيل' and not Sudo_bot(msg) and not redis:get('Globla:'..bot_id..'Free:Bots') then
if AddChannel(msg.sendMsger_user_id_) == false then
local textchuser = redis:get('Globla:'..bot_id..'text:ch:user')
if textchuser then
sendMsg(msg.chat_id_, msg.id_,'['..textchuser..']')
...
sendMsgText(msg.chat_id_,'\n👤┋ مـــن قــبــل » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n☑┋ تم تفعيل المجموعهہ‌‏ {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
redis:sadd('Globla:'..bot_id..'Chek:Groups',msg.chat_id_)  
redis:sadd('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, msg.sendMsger_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
redis:setex('Globla:'..bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 360, true)  
...
redis:set('Globla:'..bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sendMsger_user_id_,'true') 
...
redis:set('Globla:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sendMsger_user_id_,'true') 
sendMsg(msg.chat_id_, msg.id_,'☑┋ ارسل الامر الذي قمت بوضعهہ‌‏ بدلا عن القديم')  
return false
end
end
if text and redis:get('Globla:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sendMsger_user_id_) == 'true' then
...
redis:del('Globla:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sendMsger_user_id_)
return false
end
if text and redis:get('Globla:'..bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sendMsger_user_id_) == 'true' then
redis:set('Globla:'..bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
sendMsg(msg.chat_id_, msg.id_,'☑┋ ارسل الامر الجديد')  
redis:del('Globla:'..bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sendMsger_user_id_)
redis:set('Globla:'..bot_id.."Set:Cmd:Group1"..msg.chat_id_..':'..msg.sendMsger_user_id_,'true1') 
return false
end
if text and redis:get('Globla:'..bot_id.."Set:Cmd:Group1"..msg.chat_id_..':'..msg.sendMsger_user_id_) == 'true1' then
...
redis:del('Globla:'..bot_id.."Set:Cmd:Group1"..msg.chat_id_..':'..msg.sendMsger_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
redis:sadd('Globla:'..bot_id..'GBan:User', result.sendMsger_user_id_)
...
redis:srem('Globla:'..bot_id..'GBan:User', result.sendMsger_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
...
redis:del('Globla:'..bot_id..'Sudo_bot:User')
...
redis:sadd('Globla:'..bot_id..'Sudo_bot:User', result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم ترقيتهہ‌‏ مطور في البوت'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Sudo_bot:User', result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم تنزيلهہ‌‏ من المطورين'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم ترقيتهہ‌‏ منشئ'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
redis:del('Globla:'..bot_id..'Owners'..msg.chat_id_)
texts = '🗑┋  تم مسح المدراء '
sendMsg(msg.chat_id_, msg.id_, texts)
end
if text == ("المدراء") and Constructor(msg) then
local list = redis:smembers('Globla:'..bot_id..'Owners'..msg.chat_id_)
t = "\n📃┋ قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = redis:get('Globla:'..bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Owners'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم ترقيتهہ‌‏ مدير'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
redis:sadd('Globla:'..bot_id..'Owners'..msg.chat_id_, result.id_)
usertext = '\n👤┋المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n☑┋ تم ترقيتهہ‌‏ مدير'
texts = usertext..status
else
...
redis:sadd('Globla:'..bot_id..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم ترقيتهہ‌‏ مدير'
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Owners'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
if result.id_ then
redis:srem('Globla:'..bot_id..'Owners'..msg.chat_id_, result.id_)
usertext = '\n👤┋المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n☑┋ تم تنزيلهہ‌‏ من المدراء'
texts = usertext..status
else
...
redis:srem('Globla:'..bot_id..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم تنزيلهہ‌‏ من المدراء'
...
redis:sadd('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n☑┋ تم ترقيتهہ‌‏ ادمن'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
local  statuss  = '\n☑┋ تم ترقيتهہ‌‏ مميز هنا '
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
redis:sadd('Globla:'..bot_id..'Ban:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🚫┋ تم حظره من المجموعه'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
redis:srem('Globla:'..bot_id..'Ban:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
redis:sadd('Globla:'..bot_id..'Muted:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔇┋ تم كتمه من هنا'
sendMsg(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Muted:User'..msg.chat_id_, result.sendMsger_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sendMsger_user_id_},function(arg,data) 
usertext = '\n👤┋ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
if redis:sismember('Globla:'..bot_id..'Muted:User'..msg.chat_id_,result.sendMsger_user_id_) then
Muted = 'مكتوم'
else
Muted = 'غير مكتوم'
end
if redis:sismember('Globla:'..bot_id..'Ban:User'..msg.chat_id_,result.sendMsger_user_id_) then
Ban = 'محظور'
else
Ban = 'غير محظور'
end
if redis:sismember('Globla:'..bot_id..'GBan:User',result.sendMsger_user_id_) then
GBan = 'محظور عام'
else
GBan = 'غير محظور عام'
end
...
if not redis:get('Globla:'..bot_id..'Reply:Sudo_bot'..msg.chat_id_) then
rdsudo = 'مفتوح'
else
rdsudo = 'مقفول'
end
if not redis:get('Globla:'..bot_id..'Bot:Id'..msg.chat_id_)  then
idgp = 'مفتوح'
else
idgp = 'مقفول'
end
if not redis:get('Globla:'..bot_id..'Bot:Id:Photo'..msg.chat_id_) then
idph = 'مفتوح'
else
idph = 'مقفول'
end
...
redis:setex('Globla:'..bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sendMsger_user_id_,120,true) 
return false
end
end
...
redis:set('Globla:'..bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sendMsger_user_id_,true) 
...
if Mod(msg) then
redis:setex('Globla:'..bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 120, true)  
...
if Mod(msg) then
redis:setex('Globla:'..bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 120, true)  
...
local list = redis:smembers('Globla:'..bot_id.."repmedia"..msg.chat_id_)  
for k,v in pairs(list) do  
redis:del('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_)  
redis:del('Globla:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)  
redis:srem('Globla:'..bot_id.."repmedia"..msg.chat_id_,v)  
end  
sendMsg(msg.chat_id_, msg.id_, "☑┇ تم مسح قائمه المنع بنجاح")  
end
...
for k,v in pairs(list) do  
local zain = redis:get('Globla:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..zain..'}\n'    
end  
if #list == 0 then  
...
sendMsg(msg.chat_id_, msg.id_, '📥┇ ارسل الكلمه المراد حذفها الان')  
redis:set('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = redis:get('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
sendMsg(msg.chat_id_, msg.id_, "📥┇ ارسل تحذير عند ارسال الكلمه")  
redis:set('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_,"repp")  
redis:set('Globla:'..bot_id.."filtr1:add:reply2"..msg.sendMsger_user_id_..msg.chat_id_, text)  
redis:sadd('Globla:'..bot_id.."repmedia"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = redis:get('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_)  
if test == 'repp' then  
sendMsg(msg.chat_id_, msg.id_, '☑┇تم منع الكلمه لن يتم ارسالها بعد الان')  
redis:del('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_)  
local test = redis:get('Globla:'..bot_id.."filtr1:add:reply2"..msg.sendMsger_user_id_..msg.chat_id_)  
if text then   
redis:set('Globla:'..bot_id.."filtr1:add:reply:rd"..test..msg.chat_id_, text)  
redis:hset('Globla:'..bot_id..'filters:'..msg.chat_id_, text, 'filtered')
end  
redis:del('Globla:'..bot_id.."filtr1:add:reply2"..msg.sendMsger_user_id_..msg.chat_id_)  
return false  end  
end

if text == 'الغاء منع' and msg.reply_to_message_id_ == 0 and Mod(msg) then   
sendMsg(msg.chat_id_, msg.id_, '📥┇ ارسل الكلمه المراد حذفها من قائمه المنع')  
redis:set('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = redis:get('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
sendMsg(msg.chat_id_, msg.id_, "📮┇ تم الغاء منعها من قائمه المنع")  
redis:del('Globla:'..bot_id.."filtr1:add:reply1"..msg.sendMsger_user_id_..msg.chat_id_)  
redis:del('Globla:'..bot_id.."filtr1:add:reply:rd"..text..msg.chat_id_)  
redis:srem('Globla:'..bot_id.."repmedia"..msg.chat_id_,text)  
return false  end  
end

if text == 'المطور' or text == 'مطور' then
local Text_Dev = redis:get('Globla:'..bot_id..'Text_Dev')
if Text_Dev then 
...
redis:del('Globla:'..bot_id..'Text_Dev')
sendMsg(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and Sudo_id(msg) then
redis:set('Globla:'..bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sendMsger_user_id_,true)
sendMsg(msg.chat_id_,msg.id_,'📃┇ ارسل الكليشه الان')
return false
end
if text and redis:get('Globla:'..bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sendMsger_user_id_) then
if text == 'الغاء' then 
redis:del('Globla:'..bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sendMsger_user_id_)
sendMsg(msg.chat_id_,msg.id_,'☑┇تم الغاء حفظ كليشة المطور')
return false
end
redis:set('Globla:'..bot_id..'Text_Dev',text)
redis:del('Globla:'..bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sendMsger_user_id_)
sendMsg(msg.chat_id_,msg.id_,'☑┇تم حفظ كليشة المطور')
return false
end
...
redis:setex('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sendMsger_user_id_,240,true)  
local Text= [[
📃┋ارسل الان النص
🔰┋ يمكنك اضافهہ‌‏ :
...
redis:del('Globla:'..bot_id.."KLISH:ID"..msg.chat_id_)
sendMsg(msg.chat_id_, msg.id_, '🗑┋ تم ازالة كليشة الايدي ')
end
return false  
end 

if redis:get('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sendMsger_user_id_) then 
if text == 'الغاء' then 
sendMsg(msg.chat_id_, msg.id_,"🌀┋ تم الغاء تعين الايدي") 
redis:del('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sendMsger_user_id_) 
return false  
end 
redis:del('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sendMsger_user_id_) 
local CHENGER_ID = text:match("(.*)")  
redis:set('Globla:'..bot_id.."KLISH:ID"..msg.chat_id_,CHENGER_ID)
...
if redis:get('Globla:'..bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_) then 
if text == 'الغاء' then 
sendMsg(msg.chat_id_, msg.id_, "🌀┋ تم الغاء حفظ القوانين") 
redis:del('Globla:'..bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_)
return false  
end 
...
redis:setex('Globla:'..bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sendMsger_user_id_, 600, true) 
...
redis:set('Globla:'..bot_id.."Sudo_bot:Rd"..msg.chat_id_,Teext)
...
redis:set('Globla:'..bot_id.."Owners:Rd"..msg.chat_id_,Teext) 
...
for k,v in pairs(list) do
dev = redis:get('Globla:'..bot_id.."Comd:New:rt:bot:"..v..msg.chat_id_)
if dev then
t = t..''..k..'- '..v..' » ('..dev..')\n'
else
t = t..''..k..'- '..v..'\n'
...
redis:set('Globla:'..bot_id.."Comd:New:rt"..msg.chat_id_..msg.sendMsger_user_id_,ComdNew)  
redis:sadd('Globla:'..bot_id.."Coomds"..msg.chat_id_,ComdNew)  
redis:setex('Globla:'..bot_id.."Comd:New"..msg.chat_id_..""..msg.sendMsger_user_id_,200,true)  
...
if redis:get('Globla:'..bot_id.."Comd:New"..msg.chat_id_..""..msg.sendMsger_user_id_) then 
if text and text:match("^الغاء$") then 
sendMsg(msg.chat_id_, msg.id_,"*🌀┋ تم الغاء الامر *\n✓") 
redis:del('Globla:'..bot_id.."Comd:New"..msg.chat_id_..""..msg.sendMsger_user_id_) 
return false  
end 
if text == 'مدير' then
...
local textn = redis:get('Globla:'..bot_id.."Comd:New:rt"..msg.chat_id_..msg.sendMsger_user_id_)  
...
sendMsg(msg.chat_id_, msg.id_,'\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'..'\n📬┋ تم رفعهہ‌‏ '..RTPA..' هنا\n')   
redis:set('Globla:'..bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sendMsger_user_id_,RTPA) 
redis:sadd('Globla:'..bot_id..'Special:User'..msg.chat_id_,result.sendMsger_user_id_)  
...
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_,result.sendMsger_user_id_)  
redis:del('Globla:'..bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sendMsger_user_id_)
elseif blakrt == 'ادمن' and Owners(msg) then 
sendMsg(msg.chat_id_, msg.id_,'\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'..'\n📬┋ تم تنزيلهہ‌‏ من '..RTPA..' هنا\n')   
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_,result.sendMsger_user_id_) 
redis:del('Globla:'..bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sendMsger_user_id_)
...
redis:del('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sendMsger_user_id_) 
end
if text == "رسايلي" or text == "رسائلي" or text == "msg" then 
sendMsg(msg.chat_id_, msg.id_,'📨┋ عدد رسائلك هنا » { '..redis:get('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sendMsger_user_id_)..'}' ) 
end 
----------------------------------------------------------
if text == 'تفعيل الاذاعه' and Sudo_id(msg) then  
if redis:get('Globla:'..bot_id..'Bc:Bots') then
redis:del('Globla:'..bot_id..'Bc:Bots') 
Text = '\n☑┋ تم تفعيل الاذاعه ' 
else
...
if not redis:get('Globla:'..bot_id..'Bc:Bots') then
redis:set('Globla:'..bot_id..'Bc:Bots',true) 
Text = '\n🚫┋ تم تعطيل الاذاعه' 
else
...
if redis:get('Globla:'..bot_id..'Bc:Bots') and not Sudo_id(msg) then 
...
if redis:sismember('Globla:'..bot_id..'Sudo_bot:User',result.sendMsger_user_id_) then
dev = 'المطور ،' else dev = '' end
if redis:sismember('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, result.sendMsger_user_id_) then
crr = 'منشئ اساسي ،' else crr = '' end
if redis:sismember('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sendMsger_user_id_) then
cr = 'منشئ ،' else cr = '' end
if redis:sismember('Globla:'..bot_id..'Owners'..msg.chat_id_, result.sendMsger_user_id_) then
own = 'مدير ،' else own = '' end
if redis:sismember('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_) then
mod = 'ادمن ،' else mod = '' end
if redis:sismember('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_) then
vip = 'مميز ،' else vip = ''
end
...
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Sudo_bot:User',msg.sendMsger_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Owners'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_,result.sendMsger_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, msg.sendMsger_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Owners'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sendMsger_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Constructor'..msg.chat_id_, msg.sendMsger_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Owners'..msg.chat_id_, result.sendMsger_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Owners'..msg.chat_id_, msg.sendMsger_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sendMsger_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sendMsger_user_id_)
end
end
...
local test = redis:get('Globla:'..bot_id..'Text:Sudo_bot:Bot'..msg.sendMsger_user_id_..':'..msg.chat_id_)
if redis:get('Globla:'..bot_id..'Set:Rd'..msg.sendMsger_user_id_..':'..msg.chat_id_) == 'true1' then
redis:del('Globla:'..bot_id..'Set:Rd'..msg.sendMsger_user_id_..':'..msg.chat_id_)
...
if redis:get('Globla:'..bot_id..'Set:Rd'..msg.sendMsger_user_id_..':'..msg.chat_id_) == 'true' then
sendMsg(msg.chat_id_, msg.id_,'📥┋ ارسل الرد الذي تريدهہ‌‏ سواء كان { متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }')
redis:set('Globla:'..bot_id..'Set:Rd'..msg.sendMsger_user_id_..':'..msg.chat_id_, 'true1')
redis:set('Globla:'..bot_id..'Text:Sudo_bot:Bot'..msg.sendMsger_user_id_..':'..msg.chat_id_, text)
redis:sadd('Globla:'..bot_id..'List:Rd:Sudo_bot', text)
return false end
end
if text and text:match("^(.*)$") then
if redis:get('Globla:'..bot_id..'Set:On'..msg.sendMsger_user_id_..':'..msg.chat_id_) == 'true' then
...
redis:del('Globla:'..bot_id..'Set:On'..msg.sendMsger_user_id_..':'..msg.chat_id_)
...
redis:set('Globla:'..bot_id..'Set:Rd'..msg.sendMsger_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد عام' and Sudo_id(msg) then 
sendMsg(msg.chat_id_, msg.id_,'☑┋ ارسل الكلمهہ‌‏ التري تريد حذفها')
redis:set('Globla:'..bot_id..'Set:On'..msg.sendMsger_user_id_..':'..msg.chat_id_,true)
return false 
end
if text and not redis:get('Globla:'..bot_id..'Reply:Sudo_bot'..msg.chat_id_) then
if not redis:sismember('Globla:'..bot_id..'Spam:Texting'..msg.sendMsger_user_id_,text) then
...
redis:sadd('Globla:'..bot_id..'Spam:Texting'..msg.sendMsger_user_id_,text) 
end
if stekr then 
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = redis:get('Globla:'..bot_id..'Text:Owners'..msg.sendMsger_user_id_..':'..msg.chat_id_..'')
if redis:get('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_) == 'true1' then
redis:del('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_)
if msg.content_.sticker_ then   
...
if text and text:match("^(.*)$") then
if redis:get('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_) == 'true' then
sendMsg(msg.chat_id_, msg.id_,'📥┋ ارسل الرد الذي تريدهہ‌‏ سواء كان { متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }')
redis:set('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_,'true1')
redis:set('Globla:'..bot_id..'Text:Owners'..msg.sendMsger_user_id_..':'..msg.chat_id_, text)
...
if text and text:match("^(.*)$") then
if redis:get('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_..'') == 'true2' then
...
sendMsg(msg.chat_id_, msg.id_,'📝┋ ارسل الكلمهہ‌‏ التري تريد اضافتها')
redis:set('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_,true)
return false 
end
...
sendMsg(msg.chat_id_, msg.id_,'📝┋ ارسل الكلمهہ‌‏ التري تريد حذفها')
redis:set('Globla:'..bot_id..'Set:Owners:rd'..msg.sendMsger_user_id_..':'..msg.chat_id_,'true2')
return false 
end
...
if redis:get('Globla:'..bot_id..'Left:Bot'..msg.chat_id_) then
...
if not redis:get('Globla:'..bot_id..'Left:Bot'..msg.chat_id_) then
...
if redis:get('Globla:'..bot_id..'Reply:Owners'..msg.chat_id_) then
...
if redis:get('Globla:'..bot_id..'Reply:Sudo_bot'..msg.chat_id_) then
redis:del('Globla:'..bot_id..'Reply:Sudo_bot'..msg.chat_id_)  
...
if not redis:get('Globla:'..bot_id..'Reply:Sudo_bot'..msg.chat_id_) then
redis:set('Globla:'..bot_id..'Reply:Sudo_bot'..msg.chat_id_,true)   
...
if redis:get('Globla:'..bot_id..'Bot:Id'..msg.chat_id_)  then
redis:del('Globla:'..bot_id..'Bot:Id'..msg.chat_id_) 
Text = '\n☑┋ تم تفعيل الايدي' 
else
...
if not redis:get('Globla:'..bot_id..'Bot:Id'..msg.chat_id_)  then
redis:set('Globla:'..bot_id..'Bot:Id'..msg.chat_id_,true) 
Text = '\n🚫┋ تم تعطيل الايدي' 
else
...
if redis:get('Globla:'..bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
redis:del('Globla:'..bot_id..'Bot:Id:Photo'..msg.chat_id_) 
...
if not redis:get('Globla:'..bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
redis:set('Globla:'..bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
...
if redis:get('Globla:'..bot_id..'Lock:kick'..msg.chat_id_)  then
...
if redis:get('Globla:'..bot_id..'Lock:Add:Bot'..msg.chat_id_)  then
...
local Msguser = tonumber(redis:get('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..result.sendMsger_user_id_) or 1) 
local Contact = tonumber(redis:get('Globla:'..bot_id..'Add:Contact'..msg.chat_id_..':'..result.sendMsger_user_id_) or 0) 
local NUMPGAME = tonumber(redis:get('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..result.sendMsger_user_id_) or 0)
local edit = tonumber(redis:get('Globla:'..bot_id..'edits'..msg.chat_id_..result.sendMsger_user_id_) or 0)
...
local Added_Me = redis:get('Globla:'..bot_id.."Who:Added:Me"..msg.chat_id_..':'..msg.sendMsger_user_id_)
if Added_Me then 
...
if redis:get('Globla:'..bot_id..'Added:Me'..msg.chat_id_) then
...
if redis:get('Globla:'..bot_id..'Seh:User'..msg.chat_id_) then
...
if redis:get('Globla:'..bot_id..'Cick:Me'..msg.chat_id_) then
...
-------------------------------------------------------------------
if text == ("ايدي") and msg.reply_to_message_id_ == 0 and not redis:get('Globla:'..bot_id..'Bot:Id'..msg.chat_id_) then      
if not redis:sismember('Globla:'..bot_id..'Spam:Texting'..msg.sendMsger_user_id_,text) then
redis:sadd('Globla:'..bot_id..'Spam:Texting'..msg.sendMsger_user_id_,text) 
...
local Msguser = tonumber(redis:get('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sendMsger_user_id_) or 1) 
local Contact = tonumber(redis:get('Globla:'..bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sendMsger_user_id_) or 0) 
local NUMPGAME = tonumber(redis:get('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_) or 0)
local rtp = Rutba(msg.sendMsger_user_id_,msg.chat_id_)
local username = '@'..(result.username_ or 'لا يوجد')
local iduser = msg.sendMsger_user_id_
local edit = tonumber(redis:get('Globla:'..bot_id..'edits'..msg.chat_id_..msg.sendMsger_user_id_) or 0)
...
if not redis:get('Globla:'..bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
local get_id_text = redis:get('Globla:'..bot_id.."KLISH:ID"..msg.chat_id_)
if get_id_text then
...
local Num = tonumber(redis:get('Globla:'..bot_id..'edits'..msg.chat_id_..msg.sendMsger_user_id_) or 0)
if Num == 0 then 
...
redis:del('Globla:'..bot_id..'edits'..msg.chat_id_..msg.sendMsger_user_id_)
end
----------------------------------------------------------------------------
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
sendMsg(msg.chat_id_, msg.id_,'🗑┋ تم مسح جهاتك'  )  
redis:del('Globla:'..bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sendMsger_user_id_)
end
----------------------------------------------------------------------------
if text == 'جهاتي' or text == 'شكد ضفت' then 
local Num = tonumber(redis:get('Globla:'..bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sendMsger_user_id_) or 0) 
if Num == 0 then 
...
redis:incrby('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_, 1)  
end
...
if redis:get('Globla:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then  
...
redis:del('Globla:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sendMsger_user_id_)
redis:del('Globla:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)   
redis:incrby('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_,5)  
sendMsg(msg.chat_id_, msg.id_,'🔖┋ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┋ تم اضافة { 5 } من النقاط \n')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby('Globla:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sendMsger_user_id_,1)
if tonumber(redis:get('Globla:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sendMsger_user_id_)) >= 3 then
redis:del('Globla:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sendMsger_user_id_)
redis:del('Globla:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)   
...
redis:setex('Globla:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 100, true)  
return false  
end
end

if redis:get('Globla:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
...
if tonumber(NUM) == tonumber(GETNUM) then
redis:del('Globla:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)   
sendMsg(msg.chat_id_, msg.id_,'📮┋ مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊┋ لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
redis:incrby('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del('Globla:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)   
...
redis:setex('Globla:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 100, true)  
return false  
end
end
...
if not redis:get('Globla:'..bot_id..'Lock:Games'..msg.chat_id_)  then
...
local Num = redis:get('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_) or 0
if Num == 0 then 
...
if tonumber(redis:get('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_)) == tonumber(0) then
sendMsg(msg.chat_id_,msg.id_,'✖¦ ليس لديك نقاط من الالعاب \n📬┋ اذا كنت تريد ربح النقاط \n📌┋ ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = redis:get('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
sendMsg(msg.chat_id_,msg.id_,'\n✖┋ ليس لديك نقاط بهہ‌‏ذا العدد \n📬┋ لزيادة نقاطك في اللعبه \n📌┋ ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
redis:decrby('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sendMsger_user_id_,NUMPY)  
redis:incrby('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sendMsger_user_id_,NUMNKO)  
...
if redis:get('Globla:'..bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then 
if text and text:match("^الغاء$") then 
redis:del('Globla:'..bot_id..'id:user'..msg.chat_id_)  
sendMsg(msg.chat_id_, msg.id_, "☑┋ تم الغاء الامر ") 
redis:del('Globla:'..bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
return false  
end 
redis:del('Globla:'..bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
...
------------------------------------------------------------------------
if redis:get('Globla:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_) then 
if text and text:match("^الغاء$") then 
redis:del('Globla:'..bot_id..'idgem:user'..msg.chat_id_)  
sendMsg(msg.chat_id_, msg.id_, "☑┋ تم الغاء الامر ") 
redis:del('Globla:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
return false  
end 
redis:del('Globla:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_)  
local numadded = string.match(text, "(%d+)") 
...
redis:setex('Globla:'..bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 120, true)  
...
redis:setex('Globla:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sendMsger_user_id_, 120, true)  
...
redis:incrby('Globla:'..bot_id..'NUM:GAMES'..msg.chat_id_..result.sendMsger_user_id_,Num)  
...
function reply(extra, result, success)
redis:del('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..result.sendMsger_user_id_) 
redis:incrby('Globla:'..bot_id..'Msg_User'..msg.chat_id_..':'..result.sendMsger_user_id_,Num)  
...
--------------------------------------------------------------------------------------------------------------
if text and not redis:sismember('Globla:'..bot_id..'Spam:Texting'..msg.sendMsger_user_id_,text) then
redis:del('Globla:'..bot_id..'Spam:Texting'..msg.sendMsger_user_id_) 
end
--------------------------------------------------------------------------------------------------------------
if text then
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
redis:set('Globla:'..bot_id.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sendMsger_user_id_)
local mem_id = msg.content_.members_  
...
redis:set('Globla:'..bot_id..'user:Name'..msg.sendMsger_user_id_,(data.username_))
end
--------------------------------------------------------------------------------------------------------------
local Getredis = redis:get('Globla:'..bot_id.."Chen:Photo"..msg.sendMsger_user_id_)
...
redis:set('Globla:'..bot_id.."Chen:Photo"..msg.sendMsger_user_id_, data.profile_photo_.id_) 
return false
end
end
end,nil)   
...
redis:incr('Globla:'..bot_id..'edits'..result.chat_id_..result.sendMsger_user_id_)
