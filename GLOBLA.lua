...
------------------------------------------------------------------------------------------------------------
function Dev_GLOBLA(msg)  
local Dev_GLOBLA = false  
...
function Dev_GLOBLA_User(user)  
local Dev_GLOBLA_User = false  
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_GLOBLA_User = true  
end  
end  
return Dev_GLOBLA_User  
end 
function DeveloperBot(msg) 
local Status = redis:sismember(bot_id.."Developer:Bot", msg.sender_user_id_) 
if Status or Dev_GLOBLA(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_GLOBLA(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_GLOBLA(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_GLOBLA(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_GLOBLA(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_GLOBLA(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
if Dev_GLOBLA_User(user_id) then
Status = true  
...
if Dev_GLOBLA_User(user_id) == true then
...
url = 'https://raw.githubusercontent.com/NOVAR1/STORM/master/GLOBLA.lua'
file_path = 'GLOBLA.lua'
local respbody = {} 
local options = { url = url, sink = ltn12.sink.table(respbody), redirect = true } 
local response = nil 
options.redirect = false 
...
------------------------------------------------------------------------------------------------------------
function FilesGLOBLA(msg)
File_Bot = dofile("Script.lua")
if File_Bot.GLOBLA and msg then
Text_File = File_Bot.GLOBLA(msg)
end
send(msg.chat_id_, msg.id_,Text_File)  
return false
end
function FilesGLOBLABot(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
Text_FileBot = dofile("Files/"..v)
if Text_FileBot.GLOBLAFile and msg then
Text_FileBot = Text_FileBot.GLOBLAFile(msg)
end
end
end
...
------------------------------------------------------------------------------------------------------------
function Dev_GLOBLA_File(msg,data)
if msg then
msg = data.message_
...
------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' or text == 'الغاء ✖' then 
redis:del(bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'〽┇تم الغاء حفظ كليشة المطور')
return false
end
redis:set(bot_id..'Texting:DevGLOBLA',text)
redis:del(bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_)
...
download_to_file('https://raw.githubusercontent.com/NOVAR1/STORM/master/GLOBLA.lua','GLOBLA.lua') 
...
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
return false 
end
if Dev_GLOBLA(msg) then
...
if not Dev_GLOBLA(msg) and not redis:sismember(bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'Status:Lock:Twasl') then
send(msg.sender_user_id_,msg.id_,'📨┇تم ارسال رسالتك الى المطور ← { [zainj20] }')    
...
redis:set(bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
redis:del(bot_id..'Texting:DevGLOBLA')
...
if Dev_GLOBLA_User(result.id_) == true then
...
send(msg.chat_id_, msg.id_,'*👥┇ عدد المجموعات الان ← { '..#group..' } مجموعه '..storm..''..zain..'\n🔘┇اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
if text == 'رفع النسخه الاحتياطيه' and tonumber(msg.reply_to_message_id_) > 0 and Dev_GLOBLA(msg) then   
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(Arg, Data)   
...
if text == 'جلب نسخه احتياطيه' and Dev_GLOBLA(msg) or text == 'جلب نسخه الكروبات' and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
if text == ("مسح قائمه العام") and Dev_GLOBLA(msg) or text == ("مسح المحظورين عام") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
redis:del(bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, "🗑┇تم مسح المحظورين عام من البوت")
elseif text == ("مسح المطورين") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
elseif text == ("قائمه العام") and Dev_GLOBLA(msg) or text == ("المحظورين عام") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
send(msg.chat_id_, msg.id_, Gban)
elseif text == ("المطورين") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""), offset_ = 0,limit_ = 200},function(ta,zain)
local t = "\n⛔┇ قائمة الاعضاء \n━━━━━━━━━━━━━\n"
x = 0
local list = zain.members_
for k, v in pairs(list) do
x = x + 1
...
elseif text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
if Dev_GLOBLA_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "⚠┇لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
elseif text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
if text and text:match("^حظر عام @(.*)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^حظر عام @(.*)$")}, FunctionStatus, nil)
if text and text:match("^الغاء العام @(.*)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^الغاء العام @(.*)$") }, FunctionStatus, nil)
if text and text:match("^اضف مطور @(.*)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^اضف مطور @(.*)$")}, FunctionStatus, nil)
if text and text:match("^حذف مطور @(.*)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
if text and text:match("^حظر عام (%d+)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
if Dev_GLOBLA_User(text:match("^حظر عام (%d+)$")) == true then
send(msg.chat_id_, msg.id_, "⚠┇لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
if text and text:match("^الغاء العام (%d+)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
if text and text:match("^اضف مطور (%d+)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
if text and text:match("^حذف مطور (%d+)$") and Dev_GLOBLA(msg) then
local url,res = http.request('http://teamstorm.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_GLOBLA ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @GLOBLAcli }')   
...
elseif text == "تفعيل المغادره" and Dev_GLOBLA(msg) then   
redis:del(bot_id.."Status:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل مغادرة البوت") 
elseif text == "تعطيل المغادره" and Dev_GLOBLA(msg) then  
redis:set(bot_id.."Status:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "☑┇تم تعطيل مغادرة البوت") 
elseif text == "تفعيل الاذاعه" and Dev_GLOBLA(msg) then  
redis:del(bot_id.."Status:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل الاذاعه \n〽┇الان يمكن للمطورين الاذاعه" ) 
elseif text == "تعطيل الاذاعه" and Dev_GLOBLA(msg) then  
redis:set(bot_id.."Status:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل الاذاعه") 
...
elseif text == 'تفعيل البوت الخدمي' and Dev_GLOBLA(msg) then  
redis:del(bot_id..'Free:Bot') 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل البوت الخدمي \n⚡┇الان يمكن الجميع تفعيله') 
elseif text == 'تعطيل البوت الخدمي' and Dev_GLOBLA(msg) then  
redis:set(bot_id..'Free:Bot',true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل البوت الخدمي') 
...
elseif text == 'وضع كليشه المطور' and Dev_GLOBLA(msg) then
redis:set(bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📮┇ ارسل لي الكليشه الان')
...
elseif text == ("مسح ردود المطور") and Dev_GLOBLA(msg) then 
...
elseif text == ("ردود المطور") and Dev_GLOBLA(msg) then 
local list = redis:smembers(bot_id.."List:Rd:Sudo")
text = "\n📝┇قائمة ردود المطور \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Dev_GLOBLA(msg) then 
...
elseif text == "حذف رد للكل" and Dev_GLOBLA(msg) then 
...
if Dev_GLOBLA_User(msg.sender_user_id_) == true then
redis:srem(bot_id.."Developer:Bot", result.id_)
redis:srem(bot_id.."President:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Manager:Group'..msg.chat_id_, result.id_)
...
elseif text == "تغير اسم البوت" and Dev_GLOBLA(msg) or text == "تغيير اسم البوت" and Dev_GLOBLA(msg) then 
redis:setex(bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"📫┇ ارسل لي الاسم الان ")  
elseif text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DeveloperBot(msg) then 
if redis:get(bot_id.."Status:Broadcasting:Bot") and not Dev_GLOBLA(msg) then 
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,zain,success) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
local Total_Photp = (zain.total_count_ or 0)
local Texting = {
'ملاك وناسيك بكروبنه😟',
"حلغوم والله☹️ ",
"اطلق صوره🐼❤️",
...
sendPhoto(msg.chat_id_,msg.id_,zain.photos_[0].sizes_[1].photo_.persistent_id_,Get_Is_Id)
else
sendPhoto(msg.chat_id_,msg.id_,zain.photos_[0].sizes_[1].photo_.persistent_id_,'🌇┇'..Description..'\n〽┇ايديك ← '..Id..'\n👤┇معرفك ← '..UserName_User..'\n🚸┇رتبتك ← '..Status_Gps..'\n📧┇رسائلك ← '..NumMsg..'\n📝┇السحكات ← '..NumMessageEdit..' \n📊┇تتفاعلك ← '..TotalMsg..'\n💎┇ مجوهراتك ← '..Num_Games)
end
else
send(msg.chat_id_, msg.id_,'\n*〽┇ايديك ← '..Id..'\n👤┇معرفك ← *['..UserName_User..']*\n🚸┇رتبتك ← '..Status_Gps..'\n📧┇رسائلك ← '..NumMsg..'\n📝┇السحكات ← '..NumMessageEdit..' \n📊┇تتفاعلك ← '..TotalMsg..'\n💎┇ مجوهراتك ← '..Num_Games..'*') 
end
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
if text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) then
...
redis:set(bot_id.."Status:id:user"..msg.chat_id_,zain)  
...
redis:set(bot_id.."Status:idgem:user"..msg.chat_id_,zain)  
...
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
elseif text == "تنظيف المشتركين" and Dev_GLOBLA(msg) then
local pv = redis:smembers(bot_id..'Num:User:Pv')  
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]},function(arg,dataq)
...
return false
elseif text == "تنظيف الكروبات" and Dev_GLOBLA(msg) then
local group = redis:smembers(bot_id..'ChekBotAdd')  
local w = 0
local q = 0
for i = 1, #group do
...
local UserName = (b.username_ or "GLOBLAcli")
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and Dev_GLOBLA(msg) then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*☑┇ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
elseif text =='الاحصائيات' and DeveloperBot(msg) then 
send(msg.chat_id_, msg.id_,'*📋┇عدد احصائيات البوت الكامله \n━━━━━━━━━━━━━\n📮┇عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\n👤┇عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text == 'المطور' or text == 'مطور' then
local TextingDevGLOBLA = redis:get(bot_id..'Texting:DevGLOBLA')
if TextingDevGLOBLA then 
send(msg.chat_id_, msg.id_,TextingDevGLOBLA)
else
send(msg.chat_id_, msg.id_,'['..UserName_Dev..']')
end
elseif text == 'حذف كليشه المطور' and Dev_GLOBLA(msg) then
redis:del(bot_id..'Texting:DevGLOBLA')
send(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(redis:get(bot_id..'Num:Add:Bot') or 0) and not Dev_GLOBLA(msg) then
