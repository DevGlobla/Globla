...
redis:set(ZAINGLOBLA..":SUDO:ID",Jsoninfo.Info.Id)
redis:set(ZAINGLOBLA..":SUDOUSER",Jsoninfo.Info.Username)
end
else
...
SUDOUSER = redis:get(ZAINGLOBLA..":SUDOUSER"),
 }
...
if SudoBot(msg) then
local bl = '👨🏻‍💻┋ أهلا عزيزي المـطـور 👋🏻\n👨‍🎓┋ انت المـطـور الاساسي بالبوت 👨🏻‍💻\n...\n\n🚸┋ تسـتطـيع‏‏ آلتحگم بگل آلآوآمـر الموجودة بالگيبورد\n⚖️┋ فقط اضغط ع الامر ليتم التنفيذ'
local keyboard = {
{'ضع اسم للبوت ©'},
{'اذاعه بالتثبيت 📌'},
...
if redis:get(bot_id.."Status:Bc") and not SudoBot(msg) then 
...
if text=="اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if redis:get('Globla:'..bot_id.."Bc:Bots:Pin") and not SudoBot(msg) then 
send(msg.chat_id_, msg.id_,"📫┇الاذاعه معطله من قبل المطور الاساسي")
return false
end
redis:setex('Globla:'..bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
