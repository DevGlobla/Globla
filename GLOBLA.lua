...
function Owners(msg)
local hash = redis:sismember(bot_id..'Owners'..msg.chat_id_,msg.sender_user_id_)    
...
if hash or SudoBot(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Owners(msg) then    
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Owners(msg) or Mod(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif redis:sismember(bot_id..'Owners'..chat_id, user_id) then
var = true  
...
elseif redis:sismember(bot_id..'Owners'..chat_id, user_id) then
var = redis:get(bot_id.."Owners:Rd"..msg.chat_id_) or 'المدير'  
elseif redis:sismember(bot_id..'Mod:User'..chat_id, user_id) then
...
MDER = redis:smembers(bot_id..'Owners'..v)
...
redis:sadd(bot_id..'Owners'..idg,idmder)  
end
end
if v.MOD then
...
Addstart = '🌐┋مرحبا بك في بوت الحمايه'..'\n🎫┋آنا آختصاصي حمايه المجموعات'..'\n📛┋مـن آلسـبآم وآلتوجيه وآلتگرآر وآلخ...'..'\n\n📨┋ارسل ما تريد وسارسله الى المطور'..'\n\n🚶🏻‍♂️'
end 
send(msg.chat_id_, msg.id_, Addstart) 
end
end
redis:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not SudoBot(msg) and not redis:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not redis:get(bot_id..'Twasl:Bots') then
...
if redis:get(bot_id..'Twasl:Bots') then
redis:del(bot_id..'Twasl:Bots') 
Text = '\n☑┋ تم تفعيل التواصل ' 
else
...
if not redis:get(bot_id..'Twasl:Bots') then
redis:set(bot_id..'Twasl:Bots',true) 
Text = '\n🚫┋ تم تعطيل التواصل' 
else
...
local GLOBLA_Msg = redis:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if GLOBLA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id..'lock:Fshar'..msg.chat_id_) and not Owners(msg) then 
...
------------------------------------------------------------
if text and redis:get(bot_id..'lock:Iran'..msg.chat_id_) and not Owners(msg) then 
...
if text == ("تفعيل") or text:match("^[aA][dD][dD]$") and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⚠️┋ عدد اعضاء المجموعه قليله يرجى جمع >> {'..(redis:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
...
if text == ("تعطيل") or text:match("^[uU][Nn][aA][dD][dD]$") and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تفعيل") or text:match("^[aA][dD][dD]$") and not Sudo(msg) and not redis:get(bot_id..'Free:Bots') then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تحديث السورس") or text:match("^[Rr][Ee][Ll][Oo][Aa][Dd]$") and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
os.execute('rm -rf GLOBLA.lua')
os.execute('wget https://raw.githubusercontent.com/DevGlobla/GLOBLA/master/GLOBLA.lua')
send(msg.chat_id_, msg.id_,'♻┋ تم تحديث السورس \n👤┋بواسطه :  ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GLOBLA')..')') 
dofile('GLOBLA.lua')  
end
...
redis:set(bot_id..'lock:Iran'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
redis:del(bot_id..'lock:Iran'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┋بواسطه :  ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GLOBLA')..') \n🇮🇷┋ تم فتح الفارسيه')  
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == "تحديث" or text == "رست" or text:match("^[Uu][Pp][Dd][Aa][Tt][Ee]$") or text:match("^[Rr][Ee][Ss][Tt][Aa][Rr][Tt]$") and SudoBot(msg) then    
dofile('GLOBLA.lua')  
...
redis:del(bot_id..'Owners'..msg.chat_id_)
texts = '🗑┋  تم مسح المدراء '
send(msg.chat_id_, msg.id_, texts)
end
if text == ("المدراء") and Constructor(msg) then
local list = redis:smembers(bot_id..'Owners'..msg.chat_id_)
t = "\n📃┋ قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
redis:sadd(bot_id..'Owners'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته مدير'
send(msg.chat_id_, msg.id_, usertext..status)
...
redis:sadd(bot_id..'Owners'..msg.chat_id_, result.id_)
usertext = '\n👤┋المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته مدير'
texts = usertext..status
else
...
redis:sadd(bot_id..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته مدير'
...
function start_function(extra, result, success)
redis:srem(bot_id..'Owners'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
if result.id_ then
redis:srem(bot_id..'Owners'..msg.chat_id_, result.id_)
usertext = '\n👤┋المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n🔅┋ تم تنزيله من المدراء'
texts = usertext..status
else
...
redis:srem(bot_id..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم تنزيله من المدراء'
...
------------------------------------------------------------------------
if text ==("رفع الادمنيه") or text:match("^[Uu][pP][Ll][Oo][Aa][Dd] [Aa][Dd][Mm][Ii][Nn][Ss]$") and Owners(msg) then
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local num2 = 0
local admins = data.members_
for i=0 , #admins do
...
------------------------------------------------------------------------
if text == ("طرد") or text:match("^[Kk][Ii][Cc][Kk]$") and msg.reply_to_message_id_ ~=0 and Mod(msg) then
...
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
...
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
if text == ("رفع مميز") or text:match("^[Ss][Ee][Tt] [Vv][Ii][Pp]$") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل مميز")) or text:match("^[Dd][Ee][Ll] [Vv][Ii][Pp]$") and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("حظر") or text:match("^[Bb][Aa][Nn]$") and msg.reply_to_message_id_ ~= 0 and Mod(msg) then
if redis:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠┋ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'⚠┋ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
if text == ("الغاء حظر") or text:match("^[Uu][Nn][Bb][Aa][Nn]$") and msg.reply_to_message_id_ and Mod(msg) then
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
...
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'🚸┋ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠┋ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'🚸┋ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if text == ("الغاء كتم") or text:match("^[Mm][Uu][Tt][Ee]$") and msg.reply_to_message_id_ and Mod(msg) then
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
send(msg.chat_id_, msg.id_, '\n🚫┋لا يمكنك عمل ذلك في ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
if not redis:get(bot_id..'Reply:Owners'..msg.chat_id_) then
rdmder = 'مفتوح'
else
rdmder = 'مقفول'
end
...
if text ==('تثبيت') or text:match("^[Pp][Ii][Nn]$") and msg.reply_to_message_id_ ~= 0 and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'الغاء التثبيت' or text:match("^[Uu][Nn][Pp][Ii][Nn]$") and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if Mod(msg) then  
redis:set(bot_id.."Group:Link"..msg.chat_id_,true) 
...
if Mod(msg) then  
redis:del(bot_id.."Group:Link"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"🚫┋تم تعطيل الرابط") 
return false end
end
if text == ("الرابط") or text == ("رابط الكروب") or text:match("^[Li][Ii][Nn][Kk]$") then 
local status_Link = redis:get(bot_id.."Group:Link"..msg.chat_id_)
...
t = "\n📃┋ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local GLOBLA_Msg = redis:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..GLOBLA_Msg..'}\n'    
end  
if #list == 0 then  
...
redis:set(bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📃┇ ارسل الكليشه الان')
return false
end
if text and redis:get(bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
redis:del(bot_id..'Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
redis:set(bot_id.."Owners:Rd"..msg.chat_id_,Teext) 
...
send(msg.chat_id_, msg.id_,'📨┋ عدد رسائلك هنا » { '..redis:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
----------------------------------------------------------
...
----------------------------------------------------------
if text == "تفعيل التواصل" or text:match("^[Aa][cC][Tt][Ii][Vv][Aa][Tt][Ee] [Pp][Vv]$") or text:match("^[Ee][nN][aA][bB][lL][Ee] [Pp][Vv]$") and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,'☑┋ تم تفعيل التواصل' ) 
redis:del(bot_id..'Twasl:Bots') 
end
if text == "تعطيل التواصل" or text:match("^[dD][Ii][Ss][Aa][Bb][Il][Ee] [Pp][Vv]$") and SudoBot(msg) then  
...
if text == ""..(redis:get(bot_id..'Name:Bot') or 'العالمي').."" then  
Namebot = (redis:get(bot_id..'Name:Bot') or 'العالمي')
local GLOBLA_Msg = {
'كافي ترى كرهت اسمي 😤',
'اهو اجوا الملطلطين 😪😹',
'لابسك لتلح',
...
----------------------------------------------------------
if text == ("تاك للكل") or text:match("^[Tt][Aa][Gg] [Aa][Ll][Ll]$") and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
cr = 'منشئ ،' else cr = '' end
if redis:sismember(bot_id..'Owners'..msg.chat_id_, result.sender_user_id_) then
...
redis:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
redis:srem(bot_id..'Owners'..msg.chat_id_, result.sender_user_id_)
elseif redis:sismember(bot_id..'Owners'..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
redis:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
end
end
...
local list = redis:smembers(bot_id..'List:Owners'..msg.chat_id_..'')
for k,v in pairs(list) do
redis:del(bot_id.."Add:Rd:Owners:Gif"..v..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Owners:Vico"..v..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Owners:Stekrs"..v..msg.chat_id_)     
redis:del(bot_id.."Add:Rd:Owners:Text"..v..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Owners:Photo"..v..msg.chat_id_)
redis:del(bot_id.."Add:Rd:Owners:Video"..v..msg.chat_id_)
redis:del(bot_id.."Add:Rd:Owners:File"..v..msg.chat_id_)
redis:del(bot_id.."Add:Rd:Owners:Audio"..v..msg.chat_id_)
redis:del(bot_id..'List:Owners'..msg.chat_id_)
end
...
for k,v in pairs(list) do
if redis:get(bot_id.."Add:Rd:Owners:Gif"..v..msg.chat_id_) then
db = 'متحركه 🎭'
elseif redis:get(bot_id.."Add:Rd:Owners:Vico"..v..msg.chat_id_) then
db = 'بصمه 📢'
elseif redis:get(bot_id.."Add:Rd:Owners:Stekrs"..v..msg.chat_id_) then
db = 'ملصق 🃏'
elseif redis:get(bot_id.."Add:Rd:Owners:Text"..v..msg.chat_id_) then
db = 'رساله ✉'
elseif redis:get(bot_id.."Add:Rd:Owners:Photo"..v..msg.chat_id_) then
db = 'صوره 🎇'
elseif redis:get(bot_id.."Add:Rd:Owners:Video"..v..msg.chat_id_) then
db = 'فيديو 📹'
elseif redis:get(bot_id.."Add:Rd:Owners:File"..v..msg.chat_id_) then
db = 'ملف 📁'
elseif redis:get(bot_id.."Add:Rd:Owners:Audio"..v..msg.chat_id_) then
db = 'اغنيه 🎵'
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = redis:get(bot_id..'Text:Owners'..msg.sender_user_id_..':'..msg.chat_id_..'')
if redis:get(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true1' then
redis:del(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_)
if msg.content_.sticker_ then   
redis:set(bot_id.."Add:Rd:Owners:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
redis:set(bot_id.."Add:Rd:Owners:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
redis:set(bot_id.."Add:Rd:Owners:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
redis:set(bot_id.."Add:Rd:Owners:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
redis:set(bot_id.."Add:Rd:Owners:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
redis:set(bot_id.."Add:Rd:Owners:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
redis:set(bot_id.."Add:Rd:Owners:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
redis:set(bot_id.."Add:Rd:Owners:Photo"..test..msg.chat_id_, photo_in_group)  
end
send(msg.chat_id_, msg.id_,'📌┋ تم حفظ الرد بنجاح')
return false  
end  
...
if text and text:match("^(.*)$") then
if redis:get(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,'📥┋ ارسل الرد الذي تريده سواء كان { متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }')
redis:set(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_,'true1')
redis:set(bot_id..'Text:Owners'..msg.sender_user_id_..':'..msg.chat_id_, text)
redis:del(bot_id.."Add:Rd:Owners:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Owners:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Owners:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."Add:Rd:Owners:Text"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Owners:Photo"..text..msg.chat_id_)
redis:del(bot_id.."Add:Rd:Owners:Video"..text..msg.chat_id_)
redis:del(bot_id.."Add:Rd:Owners:File"..text..msg.chat_id_)
redis:del(bot_id.."Add:Rd:Owners:Audio"..text..msg.chat_id_)
redis:sadd(bot_id..'List:Owners'..msg.chat_id_..'', text)
return false end
end
if text and text:match("^(.*)$") then
if redis:get(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_..'') == 'true2' then
...
redis:del(bot_id.."Add:Rd:Owners:Audio"..text..msg.chat_id_)
redis:del(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_)
redis:srem(bot_id..'List:Owners'..msg.chat_id_..'', text)
return false
end
end
----------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'📝┋ ارسل الكلمه التري تريد اضافتها')
redis:set(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
...
send(msg.chat_id_, msg.id_,'📝┋ ارسل الكلمه التري تريد حذفها')
redis:set(bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_,'true2')
return false 
end
if text and not redis:get(bot_id..'Reply:Owners'..msg.chat_id_) then
if not redis:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
local anemi = redis:get(bot_id.."Add:Rd:Owners:Gif"..text..msg.chat_id_)   
local veico = redis:get(bot_id.."Add:Rd:Owners:Vico"..text..msg.chat_id_)   
local stekr = redis:get(bot_id.."Add:Rd:Owners:Stekrs"..text..msg.chat_id_)     
local text1 = redis:get(bot_id.."Add:Rd:Owners:Text"..text..msg.chat_id_)   
local photo = redis:get(bot_id.."Add:Rd:Owners:Photo"..text..msg.chat_id_)
local video = redis:get(bot_id.."Add:Rd:Owners:Video"..text..msg.chat_id_)
local document = redis:get(bot_id.."Add:Rd:Owners:File"..text..msg.chat_id_)
local audio = redis:get(bot_id.."Add:Rd:Owners:Audio"..text..msg.chat_id_)
------------------------------------------------------------------------
------------------------------------------------------------------------
if text1 then 
send(msg.chat_id_, msg.id_, text1)
...
----------------------------------------------------------------------------
if text == ""..(redis:get(bot_id..'Name:Bot') or 'العالمي').." غادر" or text == 'غادر' then  
...
local Users = redis:scard(bot_id..'User_Bot')  
Zn = '📈┋ الاحصائيات : \n\n'..'👥┋ عدد المجموعات المفعله : {'..Groups..'}'..'\n👤┋ عدد المشتركين في البوت : {'..Users..'}'
send(msg.chat_id_, msg.id_,Zn) 
end
return false
end
----------------------------------------------------------------------------
if text == "تفعيل المغادره" or text:match("^[Aa][cC][Tt][Ii][Vv][Aa][Tt][Ee] [Ll][Ee][Aa][Vv][Ee]$") or text:match("^[Ee][nN][aA][bB][lL][Ee] [Ll][Ee][Aa][Vv][Ee]$") and SudoBot(msg) then   
...
if text == "تعطيل المغادره" or text:match("^[dD][Ii][Ss][Aa][Bb][Il][Ee] [Ll][Ee][Aa][Vv][Ee]$") and SudoBot(msg) then  
...
if redis:get(bot_id..'Reply:Owners'..msg.chat_id_) then
Text = '🔉┋ تم تفعيل ردود المدير'
redis:del(bot_id..'Reply:Owners'..msg.chat_id_)  
else
Text = '🔉┋ تم تفعيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
...
if not redis:get(bot_id..'Reply:Owners'..msg.chat_id_) then
redis:set(bot_id..'Reply:Owners'..msg.chat_id_,true)  
...
send(msg.chat_id_, msg.id_,'☑┋ تم تفعيل الايدي بالصور') 
...
---------------------------------------------------------
if text == 'تفعيل الطرد' and Constructor(msg) then   
send(msg.chat_id_, msg.id_, '☑┇تم تفعيل - ( الحظر - الطرد )')
redis:del(bot_id..'Lock:kick'..msg.chat_id_) 
end
if text == 'تعطيل الطرد' and Constructor(msg) then  
send(msg.chat_id_, msg.id_, '☑┇تم تعطيل - ( الحظر - الطرد )')
redis:set(bot_id..'Lock:kick'..msg.chat_id_,true) 
end
----------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'☑┋ تم تفعيل امر اطردني') 
...
-------------------------------------------------------------------
if text == ("ايدي") or text:match("^[Ii][Dd]$") and msg.reply_to_message_id_ == 0 and not redis:get(bot_id..'Bot:Id'..msg.chat_id_) then      
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
redis:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل الردود' and Owners(msg) then  
send(msg.chat_id_, msg.id_, '🚫┋ تم تعطيل الردود')
redis:set(bot_id..'lock:add'..msg.chat_id_, true)
end
-------------
...
redis:set(bot_id..'id:user'..msg.chat_id_,zain)  
...
redis:set(bot_id..'idgem:user'..msg.chat_id_,zain)  
...
local Name_Bot = (redis:get(bot_id..'Name:Bot') or 'العالمي')
...
------------------------------------------------------------------------
local GLOBLAbot = redis:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if GLOBLAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"🗣┋المستخدم : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛┋["..GLOBLAbot.."] \n") 
