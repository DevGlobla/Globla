...
function SudoBot_User(user)  
local SudoBot_User = false  
for k,v in pairs(Ids_Dev) do  
if user == v then  
SudoBot_User = true  
end  
...
if Status or SudoBot(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
if SudoBot_User(user_id) == true then
...
local UserName = (data.username_ or "GLOBLAcli")
...
redis:set(bot_id.."Lock:tagservrbot"..Id_Group,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Status:Status:Lock:Spam"}
for i,v in pairs(list) do
redis:set(bot_id..v..Id_Group,"del")
end
redis:sadd(bot_id.."Chek:Groups",Id_Group)
...
------------------------------------------------------------------------------------------------------------
function SudoBot_File(msg,data)
if msg then
msg = data.message_
...
if text == '/start' then  
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
...
if not SudoBot(msg) and not redis:sismember(bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'Status:Lock:Twasl') then
...
redis:del(bot_id.."Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل مغادرة البوت") 
return false
end
if text == "تعطيل مغادرة البوت ❌" then  
redis:set(bot_id.."Lock:Left"..msg.chat_id_,true)   
...
if SudoBot_User(result.id_) == true then
...
send(msg.chat_id_, msg.id_,'*📋┇عدد احصائيات البوت الكامله \n━━━━━━━━━━━━━\n📮┇عدد المجموعات : '..(redis:scard(bot_id..'Chek:Groups') or 0)..'\n👤┇عدد المشتركين : '..(redis:scard(bot_id..'User_Bot') or 0)..'*')
return false
end
...
if text == ""..Name_Bot..' شنو رئيك بهاي' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(bot_id.."Status:Fun:Bots"..msg.chat_id_) then    
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)},function(Arg, Data) 
...
if text == 'رفع النسخه الاحتياطيه' and tonumber(msg.reply_to_message_id_) > 0 and SudoBot(msg) then   
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(Arg, Data)   
...
if text == 'جلب نسخه احتياطيه' and SudoBot(msg) or text == 'جلب نسخه الكروبات' and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
if text == ("مسح قائمه العام") and SudoBot(msg) or text == ("مسح المحظورين عام") and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
if text == ("قائمه العام") and SudoBot(msg) or text == ("المحظورين عام") and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
if SudoBot_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "⚠┇لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
local url,res = http.request('http://teamGLOBLA.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @Stormcli }')   
...
if not Constructor(msg) and redis:get(bot_id.."Lock:Ban:Group"..msg.chat_id_) then 
...
if SudoBot_User(text:match("^حظر عام (%d+)$")) == true then
send(msg.chat_id_, msg.id_, "⚠┇لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
redis:del(bot_id.."Lock:Game:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل الالعاب") 
return false  
end
if text == "تفعيل الالعاب" and Owner(msg) then  
redis:set(bot_id.."Lock:Game:Group"..msg.chat_id_,true) 
...
redis:set(bot_id.."Lock:Ban:Group"..msg.chat_id_,"true")
...
redis:del(bot_id.."Lock:Ban:Group"..msg.chat_id_)
...
if SudoBot_User(msg.sender_user_id_) == true then
redis:srem(bot_id.."Developer:Bot", result.id_)
redis:srem(bot_id.."President:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Manager:Group'..msg.chat_id_, result.id_)
...
--------------
if text == "غادر" then 
if DeveloperBot(msg) and not redis:get(bot_id.."Lock:Left"..msg.chat_id_) then 
...
if text == "تغير اسم البوت" and SudoBot(msg) or text == "تغيير اسم البوت" and SudoBot(msg) then 
redis:setex(bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"📫┇ ارسل لي الاسم الان ")  
return false 
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DeveloperBot(msg) then 
if redis:get(bot_id.."Status:Broadcasting:Bot") and not SudoBot(msg) then 
...
if not redis:get(bot_id.."Lock:Id:Photo"..msg.chat_id_)  then
IdPhoto = "← {✔️}"
else
IdPhoto = "← {✖}"
end
if not redis:get(bot_id.."Lock:Id:Py:Photo"..msg.chat_id_) then
IdPyPhoto = "← {✔️}"
else
IdPyPhoto = "← {✖}"
end
...
if not redis:get(bot_id.."Lock:Ban:Group"..msg.chat_id_)  then
Banusers = "← {✔️}"
else
Banusers = "← {✖}"
end
...
if redis:get(bot_id.."Lock:Game:Group"..msg.chat_id_) then
...
💭┇[Annotations Source](t.me/INFO_GLOBLA)
...
if tonumber(redis:get(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and SudoBot(msg) then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*☑┇ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
return false 
end
...
send(msg.chat_id_, msg.id_,'['..UserName_Globla..']')
end
return false 
end
