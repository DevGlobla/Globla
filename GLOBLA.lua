...
function Sudo(msg) 
local hash = redis:sismember('Globla:'..bot_id..'Sudo:User', msg.sender_user_id_) 
...
local hash = redis:sismember('Globla:'..bot_id..'Manager'..msg.chat_id_,msg.sender_user_id_)    
...
local Groups = redis:smembers('Globla:'..bot_id..'ChekBotAdd')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(Groups) do   
local President = redis:smembers('Globla:'..bot_id.."President:Group"..v)
local Constructor = redis:smembers('Globla:'..bot_id.."Constructor:Group"..v)
local Manager = redis:smembers('Globla:'..bot_id.."Manager:Group"..v)
local Mod = redis:smembers('Globla:'..bot_id.."Mod:Group"..v)
local Specials = redis:smembers('Globla:'..bot_id.."Special:Group"..v)
local LinkGroup = redis:get('Globla:'..bot_id.."Status:link:set:Group"..v) 
local WelcomeGroup = redis:get('Globla:'..bot_id.."Get:Welcome:Group"..v) or ''
local Status_Dev = redis:get('Globla:'..bot_id.."Developer:Bot:Reply"..v) 
local Status_Prt = redis:get('Globla:'..bot_id.."President:Group:Reply"..v) 
local Status_Cto = redis:get('Globla:'..bot_id.."Constructor:Group:Reply"..v) 
local Status_Own = redis:get('Globla:'..bot_id.."Manager:Group:Reply"..v) 
local Status_Md = redis:get('Globla:'..bot_id.."Mod:Group:Reply"..v) 
local Status_Special = redis:get('Globla:'..bot_id.."Special:Group:Reply"..v) 
local Status_Mem = redis:get('Globla:'..bot_id.."Mempar:Group:Reply"..v) 
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if Status_Special then
Get_Json = Get_Json..'"Status_Special":"'..Status_Special..'",'
end
if Status_Mem then
...
redis:sadd('Globla:'..bot_id..'User_Bot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
if not SudoBot(msg) and not redis:sismember('Globla:'..bot_id..'Ban:User_Bot',msg.sender_user_id_) and not redis:get('Globla:'..bot_id..'Tuasl:Bots') then
...
if text and redis:get('Globla:'..bot_id.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
redis:set('Globla:'..bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┋ارسل الامر الجديد")  
redis:del('Globla:'..bot_id.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
redis:set('Globla:'..bot_id.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and redis:get('Globla:'..bot_id.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
...
redis:del('Globla:'..bot_id.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
...
--------------------------------------------------------------------------------------------------------------
if text and redis:get('Globla:'..bot_id..'lock:Fshar'..msg.chat_id_) and not Manager(msg) then 
...
------------------------------------------------------------
if text and redis:get('Globla:'..bot_id..'lock:Iran'..msg.chat_id_) and not Manager(msg) then 
...
sendText(msg.chat_id_,'\n👤┋ بواسطة : ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n☑┋ تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
redis:sadd('Globla:'..bot_id..'Chek:Groups',msg.chat_id_)  
redis:sadd('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
redis:set('Globla:'..bot_id.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
redis:sadd('Globla:'..bot_id..'Sudo:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته مطور في البوت'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Sudo:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته منشئ'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته مدير'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
redis:sadd('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n🔅┋ تم ترقيته ادمن'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
function start_function(extra, result, success)
redis:sadd('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
local  statuss  = '\n🔅┋ تم ترقيته مميز هنا '
...
function start_function(extra, result, success)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┋المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
...
redis:setex('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
📃┋ارسل الان النص
🔰┋ يمكنك اضافه :
...
if redis:get('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"🌀┋ تم الغاء تعين الايدي") 
redis:del('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
redis:del('Globla:'..bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
...
redis:del('Globla:'..bot_id..'Tuasl:Bots'..msg.chat_id_)
end
if text == 'تعطيل التواصل' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_, '🚫┋ تم تعطيل التواصل')
redis:set('Globla:'..bot_id..'Tuasl:Bots'..msg.chat_id_, true)
end
----------------------------------------------------------
if text == 'تفعيل الوضع الخدمي' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_, '☑┋ تم تفعيل الوضع الخدمي')
redis:del('Globla:'..bot_id..'Free:Bots'..msg.chat_id_)
end
if text == 'تعطيل الوضع الخدمي' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_, '🚫┋ تم تعطيل الوضع الخدمي')
redis:set('Globla:'..bot_id..'Free:Bots'..msg.chat_id_, true)
end
----------------------------------------------------------
...
if redis:sismember('Globla:'..bot_id..'Sudo:User',result.sender_user_id_) then
dev = 'المطور ،' else dev = '' end
if redis:sismember('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_) then
crr = 'منشئ اساسي ،' else crr = '' end
if redis:sismember('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_) then
cr = 'منشئ ،' else cr = '' end
if redis:sismember('Globla:'..bot_id..'Manager'..msg.chat_id_, result.sender_user_id_) then
own = 'مدير ،' else own = '' end
if redis:sismember('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_) then
mod = 'ادمن ،' else mod = '' end
if redis:sismember('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_) then
vip = 'مميز ،' else vip = ''
end
...
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Sudo:User',msg.sender_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Basic:Constructor'..msg.chat_id_, msg.sender_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Constructor'..msg.chat_id_, msg.sender_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
elseif redis:sismember('Globla:'..bot_id..'Manager'..msg.chat_id_, msg.sender_user_id_) then
redis:srem('Globla:'..bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
redis:srem('Globla:'..bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
end
end
...
local Users = database:smembers(bot_id..'Chek:Groups')
local Groups = database:smembers(bot_id..'User_Bot') 
for i = 1, #Groups do
...
send(msg.chat_id_, msg.id_, '☑┋ تم تفعيل الرفع')
