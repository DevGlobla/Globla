...
print("\27[0;33m>>"..[[
   ...
   Devloper : t.me/YYBYY | My Channel : t.me/GLOBLA
...
function Canban(msg)
local hash = redis:sismember('GLOBLA:'..bot_id..'SET:BAN'..msg.chat_id_,msg.sender_user_id_)    
if hash or Sudo_id(msg) or Sudo_bot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
...
var = 'البوت'
elseif redis:sismember('GLOBLA:'..bot_id..'Set:Sudo_bot', user_id) then
var = redis:get('GLOBLA:'..bot_id.."Sudo_bot:Reply"..msg.chat_id_) or 'مطور البوت'  
elseif redis:sismember('GLOBLA:'..bot_id..'Set:Basic:Constructor'..chat_id, user_id) then
var = redis:get('GLOBLA:'..bot_id.."BasicConstructor:Reply"..msg.chat_id_) or 'منشئ اساسي'
elseif redis:sismember('GLOBLA:'..bot_id..'Set:Creator'..chat_id, user_id) then
var = redis:get('GLOBLA:'..bot_id.."Constructor:Reply"..msg.chat_id_) or 'المنشئ'  
elseif redis:sismember('GLOBLA:'..bot_id..'Set:Moder'..chat_id, user_id) then
var = redis:get('GLOBLA:'..bot_id.."Owners:Reply"..msg.chat_id_) or 'مدير الكروب'  
elseif redis:sismember('GLOBLA:'..bot_id..'Set:Admin'..chat_id, user_id) then
var = redis:get('GLOBLA:'..bot_id.."Mod:Reply"..msg.chat_id_) or 'ادمن الكروب'  
elseif redis:sismember('GLOBLA:'..bot_id..'Set:Vip'..chat_id, user_id) then  
var = redis:get('GLOBLA:'..bot_id.."Vips:Reply"..msg.chat_id_) or 'عضو مميز'  
else  
var = redis:get('GLOBLA:'..bot_id.."Memp:Reply"..msg.chat_id_) or 'عضو تافه 😹'
end  
return var
end 
...
local GLOBLA_Msg = 'بعدك يديد ᯓ'  
if msgs < 100 then 
GLOBLA_Msg = 'ضعيف ᯓ' 
elseif msgs < 200 then 
GLOBLA_Msg = 'غير متفاعل ᯓ' 
elseif msgs < 400 then 
GLOBLA_Msg = 'استمر بطل ᯓ' 
elseif msgs < 700 then 
GLOBLA_Msg = 'ملك التفاعل ᯓ' 
elseif msgs < 1200 then 
GLOBLA_Msg = 'اسد التفاعل ᯓ' 
elseif msgs < 2000 then 
GLOBLA_Msg = 'اقوى تفاعل ᯓ' 
elseif msgs < 3500 then 
GLOBLA_Msg = 'اجمل تفاعل ᯓ'  
elseif msgs < 4000 then 
GLOBLA_Msg = 'تفاعل روعه ᯓ' 
elseif msgs < 4500 then 
GLOBLA_Msg = 'التفاعل المثالي ᯓ' 
elseif msgs < 5500 then 
GLOBLA_Msg = 'اقوى متفاعل ᯓ' 
elseif msgs < 7000 then 
GLOBLA_Msg = 'ملك التفاعل ᯓ' 
elseif msgs < 9500 then 
GLOBLA_Msg = 'امبروطور التفاعل ᯓ' 
elseif msgs < 10000000000 then 
GLOBLA_Msg = 'رب التفاعل ᯓ'  
end
return GLOBLA_Msg 
end
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './Offices/'..bot_id..'.json', '܁𖠐︙عدد مجموعات التي في البوت { '..#list..'}')
end
...
send(chat,msg.id_,"܁𖠐︙ملف النسخه الاحتياطيه ليس لهذا البوت")   
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_,"܁𖠐︙ جاري ...\n܁𖠐︙ رفع الملف الان")   
else
send(chat,msg.id_,"*܁𖠐︙عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")   
end      
...
send(chat,msg.id_,"\n܁𖠐︙تم رفع الملف بنجاح وتفعيل المجموعات\n܁𖠐︙ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")   
end
...
KleshaStart = '܁𖠐︙مرحبا بك في بوت الحمايه'..'\n܁𖠐︙آنا آختصاصي حمايه المجموعات'..'\n܁𖠐︙مـن آلسـبآم وآلتوجيه وآلتگرآر وآلخ...'..'\n\n܁𖠐︙ارسل ما تريد وسارسله الى المطور'..'\n܁𖠐︙قناة السورس @GLOBLA'..'\n🚶🏻‍♂️'
end 
...
send(msg.sender_user_id_, msg.id_, '܁𖠐︙تم ارسال رسالتك الى المطور')    
...
local Text = '܁𖠐︙ تم ارسال الملصق من ↓\n - '..Name
...
if text == 'حظر' then
local Name = '['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..id_user..')'
local Text = '܁𖠐︙ العضو » '..Name..'\n܁𖠐︙ تم حظره من التواصل '
...
local GLOBLA_Msg = '\n܁𖠐︙ فشل ارسال رسالتك لان العضو قام بحظر البوت'
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء حفظ كليشه ستارت") 
redis:del('GLOBLA:'..bot_id..'Start:Bots') 
return false
end
redis:set('GLOBLA:'..bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم حفظ كليشه ستارت') 
redis:del('GLOBLA:'..bot_id..'Start:Bots') 
return false
end
...
redis:setex('GLOBLA:'..bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁𖠐︙ حسنآ ارسل لي النص الذي تريده') 
return false  
end
if text == "حذف رساله الاشتراك 📃" and Sudo_id(msg) then  
redis:del('GLOBLA:'..bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح رساله الاشتراك ") 
return false  
end
----------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '܁𖠐︙ تم تفعيل الوضع الخدمي')
redis:del('GLOBLA:'..bot_id..'lock:Free')
end
if text == 'تعطيل الوضع الخدمي 🔏' and Sudo_id(msg) then  
send(msg.chat_id_, msg.id_, '܁𖠐︙ تم تعطيل الوضع الخدمي')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تحديث السورس') 
dofile('GLOBLA.lua')  
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n܁𖠐︙ للخروج ارسل الغاء ") 
return false
end 
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ عدد المجموعات الان ← { '..#group..' } مجموعه '..globla..''..zain..'\n܁𖠐︙اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
redis:setex('GLOBLA:'..bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁𖠐︙ حسنآ ارسل لي معرف القناة') 
return false  
end
if text == "تفعيل الاشتراك الاجباري 🔭" and Sudo_id(msg) then  
if redis:get('GLOBLA:'..bot_id..'add:ch:id') then
local addchusername = redis:get('GLOBLA:'..bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_,"܁𖠐︙ الاشتراك الاجباري مفعل \n܁𖠐︙قناة الاشتراك » ["..addchusername.."]") 
else
redis:setex('GLOBLA:'..bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"܁𖠐︙ لم يتم وضع القناة \n܁𖠐︙لتعين قناة الاشتراك \n܁𖠐︙ارسل معرف القناة") 
end
return false  
end
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري 📡" and Sudo_id(msg) then  
if redis:get('GLOBLA:'..bot_id..'add:ch:username') then
local addchusername = redis:get('GLOBLA:'..bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم تفعيل الاشتراك الاجباري \n܁𖠐︙قناة الاشتراك » ["..addchusername.."]") 
else
send(msg.chat_id_, msg.id_, "܁𖠐︙ لا يوجد قناة في الاشتراك الاجباري ") 
end
return false  
end
----------------------------------------------------------------------------
...
send(msg.chat_id_,msg.id_,"܁𖠐︙ عذرا عزيزي العضو هذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end      
redis:sadd('GLOBLA:'..bot_id..'Set:Sudo_bot', result.id_)
usertext = '\n܁𖠐︙العضو » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n܁𖠐︙ تم ترقيته مطور في البوت'
texts = usertext..status
else
texts = '܁𖠐︙ لا يوجد حساب بهذا المعرف'
end
...
usertext = '\n܁𖠐︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n܁𖠐︙ تم ترقيته مطور في البوت'
...
local list = redis:smembers('GLOBLA:'..bot_id.."Groups_Users") 
send(msg.chat_id_, msg.id_,"܁𖠐︙تمت الاذاعه الى *- "..#list.." * مجموعه بالتثبيت ")     
...
if text == 'الغاء' or text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء حفظ اسم البوت") 
redis:del('GLOBLA:'..bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
redis:del('GLOBLA:'..bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
redis:set('GLOBLA:'..bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم حفظ اسم البوت")  
return false
end 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الامر الجديد")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حفظ الامر")  
...
if text == 'الغاء' or text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء الاذاعه للخاص") 
...
if text == 'الغاء' or text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء الاذاعه") 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تمت الاذاعه الى >>{"..#list.."} مجموعات في البوت ")     
redis:del('GLOBLA:'..bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم الغاء الامر ") 
...
send(msg.chat_id_, msg.id_, '܁𖠐︙ المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatconfig' then
send(msg.chat_id_, msg.id_, '܁𖠐︙ عذا لا يمكنك وضع معرف حسابات في الاشتراك ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'܁𖠐︙ عذا لا يمكنك وضع معرف مجوعه في الاشتراك ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,'܁𖠐︙ البوت ادمن في القناة \n܁𖠐︙ تم تفعيل الاشتراك الاجباري في \n܁𖠐︙ ايدي القناة ('..data.id_..')\n܁𖠐︙ معرف القناة ([@'..data.type_.channel_.username_..'])') 
redis:set('GLOBLA:'..bot_id..'add:ch:id',data.id_)
redis:set('GLOBLA:'..bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'܁𖠐︙ البوت ليس ادمن في القناة يرجى ترقيته ادمن ثم اعادة المحاوله ') 
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تغيير رسالة الاشتراك بنجاح ')
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تمت الاذاعه الى *~ "..#list.." ~* مجموعه ")     
redis:del('GLOBLA:'..bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء وضع الوصف") 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء حفظ الترحيب") 
...
if text == 'الغاء' then
send(msg.chat_id_,msg.id_,"܁𖠐︙ تم الغاء حفظ الرابط")       
...
send(msg.chat_id_,0,"܁𖠐︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n܁𖠐︙["..GLOBLA_Msg.."] \n") 
else
send(msg.chat_id_,0,"܁𖠐︙العضو : {["..data.first_name_.."](T.ME/GLOBLA)}\n܁𖠐︙["..GLOBLA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, "܁𖠐︙العضو » {[@"..data.username_.."]}\n܁𖠐︙عذراً لايمكنك ارسل الملصق في المجموعه \n" ) 
else
send(msg.chat_id_,0, "܁𖠐︙العضو » {["..data.first_name_.."](T.ME/GLOBLA)}\n܁𖠐︙عذراً لايمكنك ارسل الملصق في المجموعه \n" ) 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"܁𖠐︙العضو » {[@"..data.username_.."]}\n܁𖠐︙عذراً لايمكنك ارسل الصوره في المجموعه \n" ) 
else
send(msg.chat_id_,0,"܁𖠐︙العضو » {["..data.first_name_.."](T.ME/GLOBLA)}\n܁𖠐︙عذراً لايمكنك ارسل الصوره في المجموعه \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"܁𖠐︙العضو » {[@"..data.username_.."]}\n܁𖠐︙عذراً لايمكنك ارسل المتحركه في المجموعه \n") 
else
send(msg.chat_id_,0,"܁𖠐︙العضو » {["..data.first_name_.."](T.ME/GLOBLA)}\n܁𖠐︙عذراً لايمكنك ارسل المتحركه في المجموعه \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'܁𖠐︙عدد اعضاء المجموعه اقل من *~ {'..(redis:get('GLOBLA:'..bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if redis:sismember('GLOBLA:'..bot_id..'Groups_Users',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'܁𖠐︙المجموعه مفعله بالتأكيد ')
else
sendText(msg.chat_id_,'\n܁𖠐︙ بواسطة : ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n܁𖠐︙ تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = '܁𖠐︙تمت اضافتي الى مجموعة جديدة\n'..
'\n܁𖠐︙بواسطة » '..Name..''..
...
send(msg.chat_id_, msg.id_,'܁𖠐︙المجموعه معطله سابقا ')
else
sendText(msg.chat_id_,'\n܁𖠐︙ بواسطة : ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n܁𖠐︙ تم تعطيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if redis:sismember('GLOBLA:'..bot_id..'Groups_Users',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'܁𖠐︙المجموعه مفعله سابقا ')
else
if tonumber(data.member_count_) < tonumber(redis:get('GLOBLA:'..bot_id..'Num:Add:Bot') or 0) and not Sudo_id(msg) then
send(msg.chat_id_, msg.id_,'܁𖠐︙عدد اعضاء المجموعه اقل من *~ {'..(redis:get('GLOBLA:'..bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and Sudo_id(msg) then
os.execute('rm -rf GLOBLA.lua')
os.execute('wget https://raw.githubusercontent.com/DevGlobla/GLOBLA/master/GLOBLA.lua')
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تحديث السورس \n܁𖠐︙ بواسطة : ['..Get_Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GLOBLA')..')') 
dofile('GLOBLA.lua')  
end
------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الامر الذي قم بوضعه بدلا عن القديم")  
return false
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'܁𖠐︙بواسطة :  ['..Get_Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GLOBLA')..') \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n܁𖠐︙ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'܁𖠐︙بواسطة :  ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'GLOBLA')..')\n܁𖠐︙ تـم قفـل التاك بالكتم')  
end,nil)   
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ لا يمكنك حظر المطور الاساسي \n")
return false 
end
...
send(msg.chat_id_, msg.id_, '\n܁𖠐︙ تم مسح قائمه المنشئين الاساسين')
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙المالك : ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تنزيل الكل من جميع الرتب\n{المنشئين ، المدراء ، الادمنيه ، المميزين}')  
end

if text == 'مسح المنشئين' and BasicConstructor(msg) then
redis:del('GLOBLA:'..bot_id..'Set:Creator'..msg.chat_id_)
texts = '܁𖠐︙  تم مسح المنشئين '
send(msg.chat_id_, msg.id_, texts)
end
...
redis:del('GLOBLA:'..bot_id..'Set:Admin'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁𖠐︙  تم مسح  قائمة الادمنية  ')
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تعطيل الرفع من قبل المنشئين') 
return false
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تعطيل الطرد من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
redis:del('GLOBLA:'..bot_id..'Set:Vip'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁𖠐︙  تم مسح  قائمة الاعضاء المميزين  ')
end
if text == ("المميزين") and Mod(msg) then
local list = redis:smembers('GLOBLA:'..bot_id..'Set:Vip'..msg.chat_id_)
t = "\n܁𖠐︙ قائمة مميزين المجموعه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = redis:get('GLOBLA:'..bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if redis:get('GLOBLA:'..bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تعطيل الحظر من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '܁𖠐︙ انا لست محظورا \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, '܁𖠐︙  تم مسح قائمه المكتومين ')
end
...
send(msg.chat_id_, msg.id_, '܁𖠐︙ لا يوجد حساب بهذا المعرف')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁𖠐︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n܁𖠐︙ تم رفعه ادمن بالكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁𖠐︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..')'
status  = '\n܁𖠐︙ تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم تثبيت الرساله")   
redis:set('GLOBLA:'..bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"܁𖠐︙ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"܁𖠐︙ لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁𖠐︙ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء تثبيت الرساله")   
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم وضع عدد التكرار ('..Num..')')  
end 
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم وضع زمن التكرار ('..Num..')') 
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تعطيل الرابط") 
return false end
end
...
if link then                              
send(msg.chat_id_,msg.id_,'܁𖠐︙*رابط المجموعة* -\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
linkgp = '܁𖠐︙ *رابط المجموعة* - \n ['..linkgpp.result..']'
else
linkgp = '܁𖠐︙ لا يوجد رابط ارسل ضع رابط'
end  
...
if Mod(msg) then
send(msg.chat_id_,msg.id_,"܁𖠐︙ تم مسح الرابط ")           
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ ارسل لي الصوره') 
return false
end
...
GetWelcome = '܁𖠐︙لم يتم تعيين ترحيب للمجموعه'
end 
...
send(msg.chat_id_,msg.id_,'܁𖠐︙ ارسل الكليشه الان')
return false
end
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تعين الايدي')    
end
...
local f = '⛑︙ عدد البوتات التي هي ادمن >> {'..t..'}\n܁𖠐︙ ملاحضه علامة ال (🔅) تعني ان البوت ادمن \n💥'
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تم فحص الحسابات المحذوفه وتم طردها من المجموعة')
end,nil)
end
end
----------------------------------------------------------
...
if #list == 0 then
send(msg.chat_id_, msg.id_,'܁𖠐︙لا توجد صلاحيات مضافه')
return false
end
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ دز نـوع رتـبـه ?\n܁𖠐︙ {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "*܁𖠐︙ تم مسح الصلاحيه *\n✓") 
end
...
send(msg.chat_id_, msg.id_"܁𖠐︙ يمكنك اضافه صلاحيات {ادمن - مميز - عضو} \n܁𖠐︙ ارسل الصلاحيه مجددا\n") 
return false
end
end
if text == 'ادمن' then
if not Owners(msg) then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ يمكنك اضافه صلاحيات {مميز - عضو} \n܁𖠐︙ ارسل الصلاحيه مجددا\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"܁𖠐︙ يمكنك اضافه صلاحيات {عضو} \n܁𖠐︙ ارسل الصلاحيه مجددا\n") 
return false
end
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n܁𖠐︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'GLOBLA')..')'..'\n܁𖠐︙تم رفعه '..text1[2]..' هنا')   
redis:sadd('GLOBLA:'..bot_id..'Set:Vip'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم مسح رسائلك جميعها'  )  
redis:del('GLOBLA:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_) 
end
if text == "رسايلي" or text == "رسائلي" or text == "msg" then 
send(msg.chat_id_, msg.id_,'܁𖠐︙ عدد رسائلك هنا » { '..redis:get('GLOBLA:'..bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
----------------------------------------------------------
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'܁𖠐︙ يمكنك التنظيف ل1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if redis:get('GLOBLA:'..bot_id..'Public:radio') and not Sudo_id(msg) then 
send(msg.chat_id_, msg.id_,'܁𖠐︙ الاذاعه معطله من قبل المطور الاساسي')
return false
end
redis:setex('GLOBLA:'..bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n܁𖠐︙ للخروج ارسل الغاء ") 
...
sebd(msg.chat_id_,msg.id_,'܁𖠐︙ تم تغيير اسم المجموعه الى {['..Name..']}')  
end
end,nil) 
end
----------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ لا يمكنك تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙ليس لديه رتب حتى يمكنني تنزيله \n")
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم حفظ الرد بنجاح')
return false  
end  
end
if text and text:match("^(.*)$") then
if redis:get('GLOBLA:'..bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,'܁𖠐︙ ارسل الرد الذي تريده سواء كان { متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم ازالة الرد من قائمه ردود المطور')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم ازالة الرد من قائمه ردود المدير')
redis:del('GLOBLA:'..bot_id.."Add:Rd:Owners:Gif"..text..msg.chat_id_)   
redis:del('GLOBLA:'..bot_id.."Add:Rd:Owners:Vico"..text..msg.chat_id_)   
redis:del('GLOBLA:'..bot_id.."Add:Rd:Owners:Stekrs"..text..msg.chat_id_)     
redis:del('GLOBLA:'..bot_id.."Add:Rd:Owners:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ ارسل الكلمه التري تريد اضافتها')
redis:set('GLOBLA:'..bot_id..'Set:Owners:rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد' and Owners(msg) then
send(msg.chat_id_, msg.id_,'܁𖠐︙ ارسل الكلمه التري تريد حذفها')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ ايديه » ('..iduser..')\n܁𖠐︙ معرفه » ['..username..']\n܁𖠐︙ رتبته » ('..rtp..')\n܁𖠐︙ سحكاته » ('..edit..')\n܁𖠐︙ نقاطه » ('..NUMPGAME..')\n܁𖠐︙ جهاته » ('..Contact..')\n܁𖠐︙ رسائله » ('..Msguser..')')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تم مسح قائمه منع المتحركات')  
end
if text == 'مسح قائمه منع الصور' and Owners(msg) then     
redis:del('GLOBLA:'..bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁𖠐︙تم مسح قائمه منع الصور')  
end
if text == 'مسح قائمه منع الملصقات' and Owners(msg) then     
redis:del('GLOBLA:'..bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁𖠐︙تم مسح قائمه منع الملصقات')  
end
----------------------------------------------------------------------------
if text == 'رتبتي' then
local rtp = Get_Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁𖠐︙ رتبتك ← '..rtp)
end
----------------------------------------------------------------------------
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,'܁𖠐︙ ايديك ← '..msg.sender_user_id_)
end
----------------------------------------------
...
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'܁𖠐︙ الايدي ← ('..iduser..')\n܁𖠐︙ المعرف ← ('..username..')\n܁𖠐︙ الرتبه ← ('..rtp..')\n܁𖠐︙ نوع الكشف ← بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_,"܁𖠐︙البوت ليس ادمن بالمجموعة \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local zain = '܁𖠐︙ عدد الادمنيه : '..data.administrator_count_..
...
send(msg.chat_id_, msg.id_, '\n܁𖠐︙ عذرا لا يمكنني طرد ( '..Get_Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'܁𖠐︙ ليس لدي صلاحية حظر العضوين يرجى تفعيلها !') 
return false  
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ عذرا لا يمكنني طرد ادمنية المجموعه') 
return false  
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ المعرف خطأ ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,'܁𖠐︙ لا اسطيع صيح معرفات القنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'܁𖠐︙ لا اسطيع صيح معرفات البوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'܁𖠐︙ لا اسطيع صيح معرفات المجموعات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,'܁𖠐︙ تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,'܁𖠐︙ امر صيح تم تعطيله من قبل المدراء ') 
end
return false
end
----------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ انت منشئ المجموعه ') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '܁𖠐︙ الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,'܁𖠐︙ انت دخلت عبر الرابط') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'܁𖠐︙ امر منو ضافني تم تعطيله من قبل المدراء ') 
end
end
----------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '\n܁𖠐︙ ليس لديك صور في حسابك \n['..get_id_text..']')      
end 
end
else
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, zain.photos_[0].sizes_[1].photo_.persistent_id_,'܁𖠐︙ '..rdphoto..'\n܁𖠐︙ ايديك ← ('..msg.sender_user_id_..')\n܁𖠐︙ معرفك ← '..username..'\n܁𖠐︙ موقعك ← '..Get_Rutba(msg.sender_user_id_,msg.chat_id_)..'\n܁𖠐︙ صورك ← '..photps..'\n܁𖠐︙ تفاعلك ← '..Total_Msg(Msguser)..'\n܁𖠐︙ رسائلك ← {'..Msguser..'}\n܁𖠐︙ سحكاتك ← {'..edit..'}\n܁𖠐︙ نقاطك ← {'..NUMPGAME..'}\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉')   
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n܁𖠐︙ ايديك ← ('..msg.sender_user_id_..')\n܁𖠐︙ معرفك ← '..username..'\n܁𖠐︙ موقعك ← '..Get_Rutba(msg.sender_user_id_,msg.chat_id_)..'\n܁𖠐︙ صورك ← '..photps..'\n܁𖠐︙ تفاعلك ← '..Total_Msg(Msguser)..'\n܁𖠐︙ رسائلك ← {'..Msguser..'}\n܁𖠐︙ سحكاتك ← {'..edit..']}\n܁𖠐︙ نقاطك ← {'..NUMPGAME..'}\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉')   
else
...
if Num == 0 then 
Text = '܁𖠐︙ لم تقم بالسحك في الكتابه ليست لديك سحكات'
else
Text = '܁𖠐︙ عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
----------------------------------------------------------------------------
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم مسح سحكاتك'  )  
redis:del('GLOBLA:'..bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
----------------------------------------------------------------------------
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = '܁𖠐︙ لم تقم بااضافة اي احد'
else
Text = '܁𖠐︙ عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
----------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ اسرع واحد يدز هذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ الف مبروك لقد فزت \n܁𖠐︙ للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ الف مبروك لقد فزت \n܁𖠐︙ للعب مره اخره ارسل »{ الاسرع , ترتيب }')
redis:incrby('GLOBLA:'..bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙اوبس تخمينك خطأ \n܁𖠐︙ ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
if Num == 0 then 
Text = '܁𖠐︙ لم تلعب اي لعبه للحصول على نقاط'
else
Text = '܁𖠐︙ عدد نقاط التي رحبتها هي *» { '..Num..' } مجوهره *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,'܁𖠐︙ تم خصم *» { '..NUMPY..' }* من نقاطك \n܁𖠐︙ وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "܁𖠐︙ تم اضافة له {"..numadded..'} من النقاط', 1, 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '܁𖠐︙ ارسل لي عدد النقاط الان') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم اضافة له {"..Num..'} من النقاط')  
end
...
send(msg.chat_id_,msg.id_,'\n܁𖠐︙  اهلا عزيزي البوت هنا ادمن'..'\n💢︙  وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n܁𖠐︙  تغير معلومات المجموعه ↞ ❴ '..info..' ❵'..'\n܁𖠐︙  حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n܁𖠐︙  حظر العضوين ↞ ❴ '..restrict..' ❵'..'\n܁𖠐︙  دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n܁𖠐︙  تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n܁𖠐︙  اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
----------------------------------------------------------------------------
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'܁𖠐*︙*للأدمنيـــــــه فقــــــــط') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get('GLOBLA:'..bot_id..'text:ch:user')
...
if text == 'م4' then
if not Owners(msg) then
send(msg.chat_id_, msg.id_,'܁𖠐*︙*للمدراء فقــــــــط') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get('GLOBLA:'..bot_id..'text:ch:user')
...
if text == 'م5' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_,'܁𖠐*︙*للمنشئين فقــــــــط') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get('GLOBLA:'..bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'܁𖠐*︙*للمطور الاساسي فقــــــــط') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = redis:get('GLOBLA:'..bot_id..'text:ch:user')
...
send(msg.chat_id_,msg.id_,"*܁𖠐*︙*انا لست ادمن هنا يرجى ترقيتي \n👨🏻‍✈️*")   
return false 
end      
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
send(msg.chat_id_,msg.id_,"*܁𖠐*︙*انا بوت استطيع طرد - حظر المستخدمين \n👨🏻‍✈️*")   
return false  
end   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
redis:sadd('GLOBLA:'..bot_id..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
usertext = '\n܁𖠐*︙* العضو ❲ ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..') ❳ 📣┋تم منحه صلاحية ( طرد - حظر ) المستخدمين\n✓'
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
send(msg.chat_id_,msg.id_,"*܁𖠐*︙*انا بوت لا تستطيع منعي من الحظر - الطرد \n👨🏻‍✈️*")   
return false  
end   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
redis:srem('GLOBLA:'..bot_id..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
usertext = '\n܁𖠐*︙* العضو ❲ ['..data.first_name_..'](t.me/'..(data.username_ or 'GLOBLA')..') ❳ ܁𖠐*︙*تم الغاء منحه صلاحية ( طرد - حظر ) المستخدمين\n✓'
send(msg.chat_id_, msg.id_, usertext)
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم ازالة الامر من المجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙لا يوجد امر بهاذا الاسم تاكد من الامر واعد المحاوله")  
end
...
send(msg.chat_id_,0,'܁𖠐︙ تم التعديل على الميديا \n\n܁𖠐︙ الشخص الي قام بالتعديل\n➺➺➺ •⊱{ '..users..' }⊰•') 
end,nil)
